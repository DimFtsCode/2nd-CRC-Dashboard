                            ...
                            <div class="bordered-box " style="background-color: rgba(255,255,255,0.8); border-radius:10%;">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <p style="font-size: 18px;text-align: center;"><strong>E-mail:</strong> <a href="mailto:efod.2ake@haf.gr" style="font-weight: bold; text-decoration: none;">efod.2ake@haf.gr</a></p>
                                    </div>
                                </div>  
                            </div>
                        </div>
                            ...
                            <div class="row"> <!-- Nav tabs -->
                                ...
                                <div class="container " style="border: 1px solid #000; margin-top: 2rem; background-color: #1c4b82;border-radius:10%;">
                                    <ul class="nav nav-tabs" style="margin-top: 1rem; border-bottom: 1px solid #000;">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="#general" role="tab" data-toggle="tab" >Εθνικά</a>
                                        </li>
                                        <li class="nav-item">
