...
<html>
    <head>
    <title> 2o AKE / ΣΕΦ </title>        
    <link rel="stylesheet" type="text/css" href="../index1.css">
    <link rel="stylesheet" type="text/css" href="../styles1/sef_init0.css">
    <meta charset="UTF-8">
                    ...
                    <div  class="main-menu" >
                        ...
                        <li class="has-subnav">
                            ...
                            <li>
                                ...
                                <i class="fa fa-archive fa-2x fa-spin"></i>
                                    <span class="nav-text" style="font-weight: bold;">
                                        ΣΕΦ
                                    </span>
                                </a>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="bordered-box " style="background-color: rgba(255,255,255,0.8); border-radius:10%;">
                                <div class="row">
                                    <div class="col-12">
                                        <h1 style="text-align: center;"><strong>Σμήνος Εφοδιασμού</strong> </h2>
                                        <p style="font-size: 18px; margin-top: 2rem;text-align: center;"><strong>Εσωτερικό:</strong> 642-5700</p>
                                        <p style="font-size: 18px;text-align: center;"><strong>E-mail:</strong> <a href="mailto:efod.2ake@ata.haf.gr" style="font-weight: bold; text-decoration: none;">efod.2ake@ata.haf.gr</a></p>
                                    </div>
                                </div>
                            ...
                            <div class="row"> <!-- Nav tabs -->
                                ...
                                <div class="container " style="border: 1px solid #000; margin-top: 2rem; background-color: #1c4b82;border-radius:10%;">
                                    <ul class="nav nav-tabs" style="margin-top: 1rem; border-bottom: 1px solid #000;">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="#general" role="tab" data-toggle="tab" >Εθνικά</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link " href="#general1" role="tab" data-toggle="tab" >NATO</a>
                                        </li>
                                    </ul>
                                        ...
                                        <div role="tabpanel1" class="tab-pane" id="more1">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th scope="row">1</th>
                                                        <td> <a href="../web/sef/useful"> <span style="color: dd6b4d" ><strong> Διάφορα / Χρήσιμα </strong></span></a> </td> 
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">2</th>
