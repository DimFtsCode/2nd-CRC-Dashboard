...
<html>
    <head>
    <title> 2o AKE / ΜΟΙΡΑ ΥΠΟΣΤΗΡΙΞΗΣ </title>        
    <link rel="stylesheet" type="text/css" href="../index1.css">
    <link rel="stylesheet" type="text/css" href="../styles1/myp_init0.css">
    <meta charset="UTF-8">
                    ...
                    <div  class="main-menu" >
                        ...
                        <li class="has-subnav">
                            ...
                            <a href="./myp_init0.php">
                                    <i class="fa fa-cogs fa-2x fa-spin"></i>
                                    <span class="nav-text" style="font-weight: bold;">
                                        Μ. ΥΠΟΣΤΗΡΙΞΗΣ
                                    </span>
                                </a>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="bordered-box " style="background-color: rgba(255,255,255,0.8); border-radius:10%;">
                                <div class="row">
                                    <div class="col-12">
                                        <h1 style="text-align: center;"><strong> Μοίρα Υποστήριξης</strong> </h2>
                                    </div>
                                </div>
                                <div class="row" style="text-align: center; margin-top: 2rem;">
                                    <div class="col-3" >
                                        <h3> <strong>Μοίραρχος</strong></h3>
                                        <p style="font-size: 18px; margin-top: 2rem;"><strong>Εσωτερικό:</strong> 642-5650</p>
                                        <p style="font-size: 18px;"><strong>E-mail:</strong> <a href="mailto:dktis.myp.2ake@haf.gr" style="font-weight: bold; text-decoration: none;">dktis.myp.2ake@haf.gr</a></p>
                                    </div>
                                    <div class="col-3">
                                        <h3> <strong>Σμήνος Τ-Η</strong></h3>
                                        <p style="font-size: 18px; margin-top: 2rem;"><strong>Εσωτερικό:</strong> 642-5600</p>
                                        <p style="font-size: 18px;"><strong>E-mail:</strong> <a href="mailto:t-h.myp.2ake@haf.gr" style="font-weight: bold; text-decoration: none;">t-h.myp.2ake@haf.gr</a></p>
                                    </div>
                                    <div class="col-3">
                                        <h3> <strong>ΣΣΕ</strong></h3>
                                        <p style="font-size: 18px; margin-top: 2rem;"><strong>Εσωτερικό:</strong> 642-5750</p>
                                        <p style="font-size: 18px;"><strong>E-mail:</strong> <a href="mailto:egkat.myp.2ake@haf.gr" style="font-weight: bold; text-decoration: none;">egkat.myp.2ake@haf.gr</a></p>
                                    </div>    
                                    <div class="col-3">
                                        <h3> <strong>Σμήνος Μεταφορικών</strong></h3>
                                        <p style="font-size: 18px; margin-top: 2rem;"><strong>Εσωτερικό:</strong> 642-5800</p>
                                        <p style="font-size: 18px;"><strong>E-mail:</strong> <a href="mailto:mm.myp.2ake@haf.gr" style="font-weight: bold; text-decoration: none;">mm.myp.2ake@haf.gr</a></p>
                                    </div>    
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row"> <!-- Nav tabs -->
                                ...
                                <div class="container " style="border: 1px solid #000; margin-top: 2rem; background-color: #1c4b82;border-radius:10%;">
                                    <ul class="nav nav-tabs" style="margin-top: 1rem; border-bottom: 1px solid #000;">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link " href="#general" role="tab" data-toggle="tab" >Γενικά</a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="folders">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th scope="row">1</th>
                                                        <td> <a href="../web/myp/useful"> <span style="color: dd6b4d"><strong>Διάφορα / Χρήσιμα</strong></span></a> </td>                                                    
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">2</th>
                                                        <td ><a href="../web/myp/prs"> <span style="color: dd6b4d"><strong>#~ Ενημέρωση Προσωπικού</strong></span></a> </td>                           
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">3</th>
                                                        <td><a href="../web/myp/routes"> <span style="color: dd6b4d"><strong>Δρομολόγια Μονάδας</strong></span></a> </td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">4</th>
                                                        <td> <a href="../web/myp/checklists"> <span style="color: dd6b4d"><strong>Εγχειρίδια - CheckLists</strong></span></a> </td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">5</th>
                                                        <td> <a href="../web/myp/diagram"> <span style="color: dd6b4d"><strong>Σχεδιαγράμματα</strong></span></a> </td>  
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">6</th>
