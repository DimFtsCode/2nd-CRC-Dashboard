...
<html>
    <head>
    <title> 2o AKE / ΜΟΙΡΑ ΕΠΙΧΕΙΡΗΣΕΩΝ </title>        
    <link rel="stylesheet" type="text/css" href="../index1.css">
    <link rel="stylesheet" type="text/css" href="../styles1/me_init0.css">
    <meta charset="UTF-8">
                ...
                <!-- side bar -->
                    <div  class="main-menu" >
                        ...
                        <li class="has-subnav">
                            ...
                            <li>
                            <a href="./me_init0.php">
                                <i class="fa fa-headphones fa-2x fa-spin"></i>
                                    <span class="nav-text" style="font-weight: bold;">
                                        Μ. ΕΠΙΧΕΙΡΗΣΕΩΝ
                                    </span>
                                </a>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="bordered-box " style="background-color: rgba(255,255,255,0.8); border-radius:10%;">
                                <div class="row">
                                    <div class="col-12">
                                        <h1 style="text-align: center;"><strong> Μοίρα Επιχειρήσεων</strong> </h2>
                                    </div>
                                </div>
                                <div class="row" style="text-align: center; margin-top: 2rem;">
                                    <div class="col-3" >
                                        <h3> <strong> Μοίραρχος </strong></h3>
                                        <p style="font-size: 18px; margin-top: 2rem;"><strong>Εσωτερικό:</strong> 642-5150</p>
                                        <p style="font-size: 18px;"><strong>E-mail:</strong> <a href="mailto:dktis.epx.2ake@ata.haf.gr" style="font-weight: bold; text-decoration: none;">dktis.epx.2ake@ata.haf.gr</a></p>
                                    </div>
                                    <div class="col-3">
                                        <h3> <strong> Αξκός Επιχειρήσεων </strong></h3>
                                        <p style="font-size: 18px; margin-top: 2rem;"><strong>Εσωτερικό:</strong> 642-5155</p>
                                        <p style="font-size: 18px;"><strong>E-mail:</strong> <a href="mailto:ae.epx.2ake@ata.haf.gr" style="font-weight: bold; text-decoration: none;">ae.epx.2ake@ata.haf.gr</a></p>
                                    </div>
                                    <div class="col-3">
                                        <h3> <strong> Γραφείο Εκπαίδευσης/Επιχειρήσεων </strong></h3>
                                        <p style="font-size: 18px;"><strong>Εσωτερικό:</strong> 642-5104/5158</p>
                                        <p style="font-size: 18px;"><strong>E-mail:</strong> <a href="mailto:sdep.epx.2ake@ata.haf.gr" style="font-weight: bold; text-decoration: none;">sdep.epx.2ake@ata.haf.gr</a></p>
                                    </div>    
                                    <div class="col-3">
                                        <h3> <strong>Γραφείο Προσωπικού</strong></h3>
                                        <p style="font-size: 18px; margin-top: 2rem;"><strong>Εσωτερικό:</strong> 642-5160</p>
                                        <p style="font-size: 18px;"><strong>E-mail:</strong> <a href="mailto:prs.mepx.2ake@ata.haf.gr" style="font-weight: bold; text-decoration: none;">prs.mepx.2ake@ata.haf.gr</a></p>
                                    </div>    
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row"> <!-- Nav tabs -->
                                ...
                                <div class="container " style="border: 1px solid #000; margin-top: 2rem; background-color: #1c4b82;border-radius:10%;">
                                    <ul class="nav nav-tabs" style="margin-top: 1rem; border-bottom: 1px solid #000;">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link " href="#general1" role="tab" data-toggle="tab" >Current OPS NATO</a>
                                        </li>
                                    </ul>
                                        ...
                                        <div role="tabpanel" class="tab-pane active" id="general">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th scope="row">9</th>
                                                        <td><a href="<?php echo $fileArray[8][4]; ?>" target="_blank" style="color: dd6b4d"><strong><?php echo $fileArray[8][3]; ?></strong></a></td>                                                    
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">10</th>
                        ...
                        <div class="col-4">
                            <div class="row">
                                <div class="container " style="border: 1px solid #000; margin-top: 2rem; background-color: #1c4b82;border-radius:7%; margin-bottom: 1rem;">
                                    <ul class="nav nav-tabs"style="margin-top: 1rem; border-bottom: 1px solid #000;">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="#more" role="tab" data-toggle="tab">Αρχεία Επιχειρήσεων</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link " href="#more1" role="tab" data-toggle="tab">Χρήσιμα</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link " href="#more2" role="tab" data-toggle="tab">Υποστήριξη (MISC)</a>
                                        </li>
                                    </ul>
                                    <div class="tab-content" >
                                        <div role="tabpanel" class="tab-pane active" id="more">
                                            <table class="table" >
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th scope="row">1</th>
                                                        <td> <a href="../web/me/current_ops"> <span style="color: dd6b4d"><strong>OPS SQ Media</strong></span></a> </td>                                                    
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">2</th>
                                                        <td ><a href="../web/me/weapons"> <span style="color: dd6b4d"><strong>Μνημόνια Ομάδας Όπλων</strong></span></a> </td>                           
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">3</th>
                                                        <td><a href="../web/me/surv"> <span style="color: dd6b4d"><strong>Μνημόνια Ομάδας Επιτήρησης</strong></span></a> </td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">4</th>
                                                        <td> <a href="../web/me/nato/"> <span style="color: dd6b4d"><strong>NATO Μνημόνια / SOPs</strong></span></a> </td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">5</th>
                                                        <td> <a href="../web/me/checklists"> <span style="color: dd6b4d"><strong> Εγχειρίδια - CheckLists </strong></span></a> </td>  
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">6</th>
                                                        <td><a href="<?php echo $fileArray[20][4]; ?>" target="_blank"><?php echo $fileArray[20][3]; ?></a></td>                                                    
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">7</th>
                                                    ...
                                                    <tr>
                                                        <th scope="row">16</th>
                                                        <td> <a href="../web/me/plans"> <span style="color: dd6b4d"><strong>ΣΧΕΔΙΑ</strong></span></a> </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                        <div role="tabpanel1" class="tab-pane" id="more1">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th scope="row">1</th>
                                                        <td> <a href="../web/epit/useful"> <span style="color: dd6b4d" ><strong> Διάφορα / Χρήσιμα </strong></span></a> </td> 
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">2</th>
                                                    ...
                                                    <tr>
                                                        <th scope="row">13</th>
                                                        <td><a href="<?php echo $fileArray[41][4]; ?>" target="_blank" style="color: dd6b4d"><strong><?php echo $fileArray[41][3]; ?></strong></a></td>                                                    
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">14</th>
                                                        <td><a href="<?php echo $fileArray[42][4]; ?>" target="_blank" style="color: dd6b4d"><strong><?php echo $fileArray[42][3]; ?></strong></a></td>                                                    
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">15</th>
                                                        <td><a href="<?php echo $fileArray[43][4]; ?>" target="_blank" style="color: dd6b4d"><strong><?php echo $fileArray[43][3]; ?></strong></a></td>                                                    
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">16</th>
                                        ...
                                        <div role="tabpanel2" class="tab-pane" id="more2">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th scope="row">13</th>
                                                        <td><a href="<?php echo $fileArray[56][4]; ?>" target="_blank" style="color: dd6b4d"><strong><?php echo $fileArray[56][3]; ?></strong></a></td>                                                    
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">14</th>
                                                        <td><a href="<?php echo $fileArray[57][4]; ?>" target="_blank" style="color: dd6b4d"><strong><?php echo $fileArray[57][3]; ?></strong></a></td>                                                    
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">15</th>
