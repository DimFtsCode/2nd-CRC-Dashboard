                            ...
                            <div class="bordered-box " style="background-color: rgba(255,255,255,0.8); border-radius:10%;">
                                ...
                                <div class="row" style="text-align: center; margin-top: 2rem;">
                                    <div class="col-3" >
                                        ...
                                        <p style="font-size: 18px;"><strong>E-mail:</strong> <a href="mailto:dktis.epx.2ake@haf.gr" style="font-weight: bold; text-decoration: none;">dktis.epx.2ake@haf.gr</a></p>
                                    </div>
                                    <div class="col-3">
                                        <h3> <strong> Αξκός Επιχειρήσεων </strong></h3>
                                        <p style="font-size: 18px; margin-top: 2rem;"><strong>Εσωτερικό:</strong> 642-5155</p>
                                        <p style="font-size: 18px;"><strong>E-mail:</strong> <a href="mailto:ae.epx.2ake@haf.gr" style="font-weight: bold; text-decoration: none;">ae.epx.2ake@haf.gr</a></p>
                                    </div>
                                    <div class="col-3">
                                        <h3> <strong> Γραφείο Εκπαίδευσης/Επιχειρήσεων </strong></h3>
                                        <p style="font-size: 18px;"><strong>Εσωτερικό:</strong> 642-5104/5158</p>
                                        <p style="font-size: 18px;"><strong>E-mail:</strong> <a href="mailto:sdep.epx.2ake@haf.gr" style="font-weight: bold; text-decoration: none;">sdep.epx.2ake@haf.gr</a></p>
                                    </div>    
                                    <div class="col-3">
                                        <h3> <strong>Γραφείο Προσωπικού</strong></h3>
                                        <p style="font-size: 18px; margin-top: 2rem;"><strong>Εσωτερικό:</strong> 642-5160</p>
                                        <p style="font-size: 18px;"><strong>E-mail:</strong> <a href="mailto:prs.mepx.2ake@haf.gr" style="font-weight: bold; text-decoration: none;">prs.mepx.2ake@haf.gr</a></p>
                                    </div>    
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row"> <!-- Nav tabs -->
                                ...
                                <div class="container " style="border: 1px solid #000; margin-top: 2rem; background-color: #1c4b82;border-radius:10%;">
                                    <ul class="nav nav-tabs" style="margin-top: 1rem; border-bottom: 1px solid #000;">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link " href="#general" role="tab" data-toggle="tab" >Current OPS Εθνικά</a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="folders">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th scope="row">2</th>
                                                        <td ><a href="../web/me/useful"> <span style="color: dd6b4d"><strong>Διάφορα / Χρήσιμα</strong></span></a> </td>                           
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">3</th>
                                                        <td><a href="../web/me/prs"> <span style="color: dd6b4d"><strong>#~ Πρόγραμμα Επχ. Φυλακών</strong></span></a> </td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">4</th>
                                    ...
                                    <div class="tab-content" >
                                        ...
                                        <div role="tabpanel1" class="tab-pane" id="more1">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <?php
                                                    for ($i = 33; $i <= 45; $i++) {  // Αρχικοί δείκτες για την καρτέλα 'more1'
                                                        echo '<tr>';
                                                        echo '<th scope="row">' . ($i+1) . '</th>';
                                                        if ($fileArray[$i][3] !== '... to be determined') {
                                                            echo '<td><a href="' . htmlspecialchars($fileArray[$i][4]) . '" target="_blank" style="color: dd6b4d;"><strong>' . htmlspecialchars($fileArray[$i][3]) . '</strong></a></td>';
                                        ...
                                        <div role="tabpanel2" class="tab-pane" id="more2">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <?php
                                                    for ($i = 46; $i <= 58; $i++) {  // Αρχικοί δείκτες για την καρτέλα 'more2'
                                                        echo '<tr>';
                                                        echo '<th scope="row">' . ($i+1) . '</th>';
                                                        if ($fileArray[$i][3] !== '... to be determined') {
                                                            echo '<td><a href="' . htmlspecialchars($fileArray[$i][4]) . '" target="_blank" style="color: dd6b4d;"><strong>' . htmlspecialchars($fileArray[$i][3]) . '</strong></a></td>';
