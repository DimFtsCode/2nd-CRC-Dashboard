                            ...
                            <div class="row"> <!-- Nav tabs -->
                                ...
                                <div class="container " style="border: 1px solid #000; margin-top: 2rem; background-color: #1c4b82;border-radius:10%;">
                                    <ul class="nav nav-tabs" style="margin-top: 1rem; border-bottom: 1px solid #000;">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="#general" role="tab" data-toggle="tab" >Γενικά (1 εως 10)</a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <div role="tabpanel" class="tab-pane active" id="more">
                                            <table class="table" >
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th scope="row">2</th>
                                                        <td ><a href="../web/ydktis/nomoi"> <span style="color: dd6b4d"><strong> Νόμοι - ΦΕΚ </strong></span></a> </td>                           
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">3</th>
                                                    ...
                                                    <tr>
                                                        <th scope="row">4</th>
                                                        <td> <a href="../web/ydktis/ops"> <span style="color: dd6b4d"><strong> Current OPS - EX </strong></span></a> </td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">5</th>
                                                    ...
                                                    <tr>
                                                        <th scope="row">16</th>
                                                        <td> <a href="../web/ydktis/prs"> <span style="color: dd6b4d"><strong> Προσωπικό </strong></span></a> </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                        ...
                                        <div role="tabpanel2" class="tab-pane" id="more2">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th scope="row">1</th>
                                                        <td> <a href="../web/dktis/kepix"> <span style="color: dd6b4d"><strong>#~Ενημερώσεις / ΚΕΠΙΧ </strong></span></a> </td>
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">2</th>
