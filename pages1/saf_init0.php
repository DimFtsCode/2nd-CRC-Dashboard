                            ...
                            <div class="bordered-box " style="background-color: rgba(255,255,255,0.8); border-radius:10%;">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <p style="font-size: 18px;text-align: center;"><strong>E-mail:</strong> <a href="mailto:saf.2ake@haf.gr" style="font-weight: bold; text-decoration: none;">saf.2ake@haf.gr</a></p>
                                    </div>
                                </div>
                                        ...
                                        <div role="tabpanel" class="tab-pane active" id="folders">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th scope="row">3</th>
                                                        <td ><a href="../web/saf/prs"> <span style="color: dd6b4d"><strong>#~ Ενημέρωση Προσωπικού</strong></span></a> </td>                           
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">4</th>
