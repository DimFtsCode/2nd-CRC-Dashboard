...
<html>
    ...
    <link rel="stylesheet" type="text/css" href="../styles1/saf_init0.css">
    <meta charset="UTF-8">
                    ...
                    <div  class="main-menu" >
                        ...
                        <li class="has-subnav">
                            ...
                            <li>
                                ...
                                <i class="fa fa-shield fa-2x fa-spin"></i>
                                    <span class="nav-text" style="font-weight: bold;">
                                        ΣΑΦ
                                    </span>
                                </a>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="bordered-box " style="background-color: rgba(255,255,255,0.8); border-radius:10%;">
                                <div class="row">
                                    <div class="col-12">
                                        <h1 style="text-align: center;"><strong>Σμήνος Άμυνας-Φρούρησης</strong> </h2>
                                        <p style="font-size: 18px; margin-top: 2rem;text-align: center;"><strong>Εσωτερικό:</strong> 642-5850</p>
                                        <p style="font-size: 18px;text-align: center;"><strong>E-mail:</strong> <a href="mailto:saf.2ake@ata.haf.gr" style="font-weight: bold; text-decoration: none;">saf.2ake@ata.haf.gr</a></p>
                                    </div>
                                </div>
                                        ...
                                        <div role="tabpanel" class="tab-pane active" id="more">
                                            <table class="table" >
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th scope="row">5</th>
                                                        <td> <a href="../web/saf/checklists"> <span style="color: dd6b4d"><strong> Εγχειρίδια - CheckLists </strong></span></a> </td>  
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">6</th>
                                                    ...
                                                    <tr>
                                                        <th scope="row">16</th>
                                                        <td> <a href="../web/saf/prs"> <span style="color: dd6b4d"><strong>ΠΡΟΣΩΠΙΚΟ</strong></span></a> </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                        <div role="tabpanel1" class="tab-pane" id="more1">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th scope="row">1</th>
                                                        <td> <a href="../web/saf/useful"> <span style="color: dd6b4d" ><strong> Διάφορα / Χρήσιμα </strong></span></a> </td> 
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">2</th>
