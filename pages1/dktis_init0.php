...
<html>
    <head>        
        <title> 2o AKE / ΔΙΟΙΚΗΤΗΣ </title>        
        <?php
        // The following is used to force the browser to clear cashe every time the page is loaded  
        echo("<link rel=\"stylesheet\" type=\"text/css\"  href=\"../styles/style_dktis0.css?v=" .rand() . "\">" );        
        ?>
        ...
        <div id="container">
            ...
            <div id="menu">
                <ul>
                    ...
                    <li><a href="./ydktis_init0.php">ΥΔΚΤΗΣ</a></li>
            ...
            <div id="mainContainer">
                ...
                <div id="content">
                    <h2> <span style="text-align: center; text-decoration: underline; color: red;"> ΔΙΟΙΚΗΤΗΣ  </span> </h2>
                    ...
                    <table>
                        ...
                        <tr>
                            <td class="code"> <a href="../web/dktis/maps"> <span style="color: black; background-color: yellow; "> Χάρτες </span></a> </td>                                                    
                            <td class="custom"> <a href="../web/dktis/useful"> <span style="color: black; background-color: yellow; "> Διάφορα / Χρήσιμα </span></a> </td> 
                            <td class="sideR"> <a href="../web/dktis/kepix"> <span style="color: black; background-color: yellow; "> ΚΕΠΙΧ </span></a> </td>
                        </tr>
                        <tr>
                            <td class="code"> <a href="../web/dktis/law"> <span style="color: black; background-color: yellow; "> ΘΕΣΜΙΚΑ-ΝΟΜΟΙ </span></a> </td>                           
                        ...
                        <tr>
                            <td class="code"> <a href="../web/dktis/support"> <span style="color: yellow; background-color: orangered; "> SUPPORT </span></a> </td>
                        ...
                        <tr>
                            <td class="code"> <a href="../web/dktis/ops"> <span style="color: red; background-color: cyan; "> Current OPS </span></a> </td>
                        ...
                        <tr>
                            <td class="custom"> <a href="../web/dktis/checklists"> <span style="color: black; background-color: yellow; "> Εγχειρίδια - CheckLists </span></a> </td>  
                        ...
                        <tr>
                            <td class="code"> <a href="../web/dktis/prs"> <span style="color: red; background-color: yellow; "> ΠΡΟΣΩΠΙΚΟ </span></a> </td>
