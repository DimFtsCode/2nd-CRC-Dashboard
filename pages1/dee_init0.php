                ...
                <!-- side bar -->
                    <div  class="main-menu" >
                        ...
                        <li class="has-subnav">
                            ...
                            <li>
                                <a href="./dee_init0.php">
                                    <i class="fa fa-fighter-jet fa-2x fa-spin"></i>
                                    <span class="nav-text" style="font-weight: bold;">
                                        ΔΕΕ
                                    </span>
                                </a>
                        ...
                        <div class="col-md-12">
                            <div class="bordered-box " style="background-color: rgba(255,255,255,0.8); border-radius:5%;">
                                <div class="row" style="margin-bottom: 2rem;" >
                                    <div class="col-12" >
                                        <h1 style="text-align: center;"><strong> Διεύθυνση Επιχειρήσεων Εκπαίδευσης & Προστασίας Δυνάμεων </strong> </h1>
                                    </div>
                                </div>
                                <div class="row" style="border:1px solid #000; padding: 5px;">
                                    ...
                                    <div class="col-8">
                                        ...
                                        <p style="text-align: center; font-size: 20px;">"Τον Διευθυντή τριών δει μέμνησθαι: Πρώτον, ότι της οργάνωσης την πορεία καθορίζει. Δεύτερον, ότι με σύνεση και κατά τα επιστημονικά δεδομένα ενεργεί. Τρίτον, ότι η εξουσία του είναι υπηρεσιακή και υπό την κρίση των αποτελεσμάτων δοκιμάζεται."</p>
                                    </div>    
                                    <div class="col-2">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <h2 style="text-align: center; margin-top: 2rem; margin-bottom: 1rem;"><strong> Υπαγόμενα Γραφεία</strong> </h2>
                                    </div>
                                </div>
                                        ...
                                        <div role="tabpanel2" class="tab-pane" id="more2">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th scope="row">15</th>
                                                        <td><a href="<?php echo $fileArray[58][4]; ?>" target="_blank" ><strong><?php echo $fileArray[58][3]; ?></strong></a></td>                                                    
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">16</th>
