...
<html>
    <head>
    <title> 2o AKE / ΕΠΙΤΕΛΕΙΟ </title>        
    <link rel="stylesheet" type="text/css" href="../index1.css">
    <link rel="stylesheet" type="text/css" href="../styles1/epit_init0.css">
    <meta charset="UTF-8">
                    ...
                    <div  class="main-menu" >
                        ...
                        <li class="has-subnav">
                            ...
                            <li class="has-subnav">
                                ...
                                <i class="fa fa-comments fa-2x fa-spin"></i>
                                    <span class="nav-text" style="font-weight: bold;">
                                        ΕΠΙΤΕΛΕΙΟ
                                    </span>
                                </a>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="bordered-box " style="background-color: rgba(255,255,255,0.8); border-radius:10%;">
                                <div class="row">
                                    <div class="col-12">
                                        <h1 style="text-align: center;"><strong> Επιτελείο</strong> </h2>
                                    </div>
                                </div>
                                <div class="row" style="text-align: center;">
                                    <div class="col-3" >
                                        <h3> <strong> Υπασπιστήριο </strong></h3>
                                        <p style="font-size: 18px; margin-top: 2rem;"><strong>Εσωτερικό:</strong> 642-5001</p>
                                        <p style="font-size: 18px;"><strong>E-mail:</strong> <a href="mailto:ypasp.2ake@ata.haf.gr" style="font-weight: bold; text-decoration: none;">ypasp.2ake@ata.haf.gr</a></p>
                                    </div>
                                    <div class="col-3">
                                        <h3> <strong> T-A </strong></h3>
                                        <p style="font-size: 18px; margin-top: 2rem;"><strong>Εσωτερικό:</strong> 642-5006</p>
                                        <p style="font-size: 18px;"><strong>E-mail:</strong> <a href="mailto:grta.2ake@ata.haf.gr" style="font-weight: bold; text-decoration: none;">grta.2ake@ata.haf.gr</a></p>
                                    </div>
                                    <div class="col-3">
                                        <h3> <strong> Γ.Α.Ε </strong></h3>
                                        <p style="font-size: 18px; margin-top: 2rem;"><strong>Εσωτερικό:</strong> 642-5004</p>
                                        <p style="font-size: 18px;"><strong>E-mail:</strong> <a href="mailto:gae.2ake@ata.haf.gr" style="font-weight: bold; text-decoration: none;">gae.2ake@ata.haf.gr</a></p>
                                    </div>    
                                    <div class="col-3">
                                        <h3> <strong> Γραμματεία </strong></h3>
                                        <p style="font-size: 18px; margin-top: 2rem;"><strong>Εσωτερικό:</strong> 642-5003</p>
                                        <p style="font-size: 18px;"><strong>E-mail:</strong> <a href="mailto:gramm.2ake@ata.haf.gr" style="font-weight: bold; text-decoration: none;">gramm.2ake@ata.haf.gr</a></p>
                                    </div>    
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row"> <!-- Nav tabs -->
                                ...
                                <div class="container " style="border: 1px solid #000; margin-top: 2rem; background-color: #1c4b82;border-radius:10%;">
                                    <ul class="nav nav-tabs" style="margin-top: 1rem; border-bottom: 1px solid #000;">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="#general" role="tab" data-toggle="tab" >ΓΡ. Τ-Α ΕΘΝΙΚΑ</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link " href="#general1" role="tab" data-toggle="tab" >ΓΡ. Τ-Α ΝΑΤΟ</a>
                                        </li>
                                    </ul>
                                        ...
                                        <div role="tabpanel" class="tab-pane active" id="more">
                                            <table class="table" >
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th scope="row">5</th>
                                                        <td> <a href="../web/xxx/checklists"> <span style="color: dd6b4d"><strong> Εγχειρίδια - CheckLists </strong></span></a> </td>  
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">6</th>
