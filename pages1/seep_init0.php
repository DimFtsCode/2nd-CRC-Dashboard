...
<html>
    <head>
    <title> 2o AKE / ΣΕΕΠ </title>        
    <link rel="stylesheet" type="text/css" href="../index1.css">
    <link rel="stylesheet" type="text/css" href="../styles1/seep_init0.css">
    <meta charset="UTF-8">
                    ...
                    <div  class="main-menu" >
                        ...
                        <li class="has-subnav">
                            ...
                            <li>
                                ...
                                <i class="fa fa-minus fa-2x fa-spin"></i>
                                    <span class="nav-text" style="font-weight: bold;">
                                        ΣΕΕΠ
                                    </span>
                                </a>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="bordered-box " style="background-color: rgba(255,255,255,0.8); border-radius:10%;">
                                <div class="row">
                                    <div class="col-12">
                                        <h1 style="text-align: center;"><strong> Σμήνος Επιτελείου Εξυπηρέτησης Προσωπικού</strong> </h2>
                                    </div>
                                </div>
                                <div class="row" style="text-align: center; margin-top: 2rem;">
                                    <div class="col-3" >
                                        <h3> <strong>Διοικητής</strong></h3>
                                        <p style="font-size: 18px; margin-top: 2rem;"><strong>Εσωτερικό:</strong> 642-5900</p>
                                        <p style="font-size: 18px;"><strong>E-mail:</strong> <a href="mailto:seep.2ake@ata.haf.gr" style="font-weight: bold; text-decoration: none;">seep.2ake@ata.haf.gr</a></p>
                                    </div>
                                    <div class="col-3">
                                        <h3> <strong>Μαγειρία </strong></h3>
                                        <p style="font-size: 18px; margin-top: 2rem;"><strong>Εσωτερικό:</strong> 642-5907</p>
                                    </div>
                                    <div class="col-3">
                                        <h3> <strong>Τροφοδοσία</strong></h3>
                                        <p style="font-size: 18px; margin-top: 2rem;"><strong>Εσωτερικό:</strong> 642-5733</p>
                                    </div>    
                                    <div class="col-3">
                                        <h3> <strong>Συσσιτιάρχης ΛΑΞ</strong></h3>
                                        <p style="font-size: 18px; margin-top: 2rem;"><strong>Εσωτερικό:</strong> 642-5912</p>
                                    </div>    
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row"> <!-- Nav tabs -->
                                ...
                                <div class="container " style="border: 1px solid #000; margin-top: 2rem; background-color: #1c4b82;border-radius:10%;">
                                    <ul class="nav nav-tabs" style="margin-top: 1rem; border-bottom: 1px solid #000;">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="#general" role="tab" data-toggle="tab" >Γενικά</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link " href="#general1" role="tab" data-toggle="tab" >Υποστήριξη</a>
                                        </li>
                                    </ul>
