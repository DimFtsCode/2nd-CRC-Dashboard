...
<html>
    <head>
    <title> 2o AKE / ΔΥΠ </title>        
    <link rel="stylesheet" type="text/css" href="../index1.css">
    <link rel="stylesheet" type="text/css" href="../styles1/dyp_init0.css">
    <meta charset="UTF-8">
        ...
        <div class="container-fluid d-flex flex-column min-vh-100 bg-white" >
            ...
            <div class="row flex-grow-1" >
                        ...
                        <li class="has-subnav">
                            ...
                            <li>
                                <a href="./dyp_init0.php">
                                    <i class="fa fa-folder-open fa-2x fa-spin"></i>
                                    <span class="nav-text" style="font-weight: bold;">
                                        ΔΥΠ
                                    </span>
                                </a>
                ...
                <div class="background1-image-wrapper col-10">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="bordered-box " style="background-color: rgba(255,255,255,0.8); border-radius:5%;">
                                <div class="row" style="margin-bottom: 2rem;" >
                                    <div class="col-12" >
                                        <h1 style="text-align: center;"><strong> Διεύθυνση Υποστήριξης </strong> </h1>
                                    </div>
                                </div>
                                <div class="row" style="border:1px solid #000; padding: 5px;">
                                    <div class="col-2" >
                                        <div style="border:2px solid #000 ">
                                            <img src="../images/2ake_over1.jpg"  class="img-fluid rounded border" alt="Διευθυντής">
                                        </div>
                                    </div>
                                    <div class="col-8">
                                        <h2 style="text-align: center;"><strong> Διευθυντής</strong> </h2>
                                        <p style="text-align: center; font-size: 20px;">"Τον Διευθυντή Υποστήριξης τριών δει μέμνησθαι: Πρώτον, ότι την ομαλότητα και την αποδοτικότητα των λειτουργιών εξασφαλίζει. Δεύτερον, ότι με ευελιξία και προσαρμοστικότητα στις ανάγκες ανταποκρίνεται. Τρίτον, ότι η δύναμή του στην υποστήριξη των άλλων τμημάτων και στην ομαδική συνεργασία αποτυπώνεται."</p>
                                    </div>    
                                    <div class="col-2">
                                        <p style="font-size: 18px;"><strong>Εσωτερικό:</strong> 642-5030</p>
                                        <p style="font-size: 18px;"><strong>E-mail:</strong> <a href="mailto:dyp.2ake@ata.haf.gr" style="font-weight: bold; text-decoration: none;">dyp.2ake@ata.haf.gr</a></p>
                                        ...
                                        <div class="modal-dialog modal-lg" role="document"> <!-- 'modal-lg' for larger modal -->
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="bioModalLabel">Βιογραφικό Διευθυντή</h5>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <h2 style="text-align: center; margin-top: 2rem; margin-bottom: 1rem;"><strong> Υπαγόμενα Τμήματα</strong> </h2>
                                    </div>
                                </div>
                                <div class="row" style="text-align: center; margin-top: 2rem; margin-bottom: 2rem;">
                                    <div class="col-3" >
                                        <h3> <strong> Συντήρησης </strong></h3>
                                        <p style="font-size: 18px;"><strong>Εσωτερικό:</strong> 642-5032</p>
                                        <p style="font-size: 18px;"><strong>E-mail:</strong> <a href="mailto:synt.dyp.2ake@ata.haf.gr" style="font-weight: bold; text-decoration: none;">synt.dyp.2ake@ata.haf.gr</a></p>
                                    </div>
                                    <div class="col-3">
                                        <h3> <strong> Πληροφορικής </strong></h3>
                                        <p style="font-size: 18px;"><strong>Εσωτερικό:</strong> 642-5074</p>
                                        <p style="font-size: 18px;"><strong>E-mail:</strong> <a href="mailto:it.dyp.2ake@ata.haf.gr" style="font-weight: bold; text-decoration: none;">it.dyp.2ake@ata.haf.gr</a></p>
                                    </div>
                                    <div class="col-3">
                                        <h3> <strong> Ποιοτικού Ελέγχου </strong></h3>
                                        <p style="font-size: 18px;"><strong>Εσωτερικό:</strong> 642-5060</p>
                                        <p style="font-size: 18px;"><strong>E-mail:</strong> <a href="mailto:tpe.dyp.2ake@ata.haf.gr" style="font-weight: bold; text-decoration: none;">tpe.dyp.2ake@ata.haf.gr</a></p>
                                    </div>    
                                    <div class="col-3">
                                        <h3> <strong> Ηλεκτρ. Εγκαταστάσεων </strong></h3>
                                        <p style="font-size: 18px;"><strong>Εσωτερικό:</strong> 642-5075</p>
                                        <p style="font-size: 18px;"><strong>E-mail:</strong> <a href="mailto:egk.dyp.2ake@ata.haf.gr" style="font-weight: bold; text-decoration: none;">egk.dyp.2ake@ata.haf.gr</a></p>
                                    </div>    
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div role="tabpanel" class="tab-pane active" id="general">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th scope="row">3</th>
                                                        <td><a href="<?php echo $fileArray[2][4]; ?>" target="_blank" style="color: dd6b4d" ><strong><?php echo $fileArray[2][3]; ?></strong></a></td>    
                                                     </tr>
                                                    <tr>
                                                        <th scope="row">4</th>
                                                        <td><a href="<?php echo $fileArray[3][4]; ?>" target="_blank" style="color: dd6b4d" ><strong><?php echo $fileArray[3][3]; ?></strong></a></td>    
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">5</th>
                                                        <td><a href="<?php echo $fileArray[4][4]; ?>" target="_blank" style="color: dd6b4d" ><strong><?php echo $fileArray[4][3]; ?></strong></a></td>    
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">6</th>
                                                        <td><a href="<?php echo $fileArray[5][4]; ?>" target="_blank" style="color: dd6b4d" ><strong><?php echo $fileArray[5][3]; ?></strong></a></td>    
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">7</th>
                                                        <td><a href="<?php echo $fileArray[6][4]; ?>" target="_blank" style="color: dd6b4d" ><strong><?php echo $fileArray[6][3]; ?></strong></a></td>    
                                                     </tr>
                                                    <tr>
                                                        <th scope="row">8</th>
                        ...
                        <div class="col-4">
                            <div class="row">
                                <div class="container " style="border: 1px solid #000; margin-top: 2rem; background-color: #1c4b82;border-radius:7%; margin-bottom: 1rem;">
                                    <ul class="nav nav-tabs"style="margin-top: 1rem; border-bottom: 1px solid #000;">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="#more" role="tab" data-toggle="tab">Αρχεία</a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <div role="tabpanel" class="tab-pane active" id="more">
                                            <table class="table" >
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th scope="row">1</th>
                                                        <td> <a href=""> <span style="color: dd6b4d"><strong> ... TDB </strong></span></a> </td>                                                    
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">2</th>
                                        ...
                                        <div role="tabpanel2" class="tab-pane" id="more2">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th scope="row">3</th>
                                                        <td><a href="<?php echo $fileArray[46][4]; ?>" target="_blank" ><?php echo $fileArray[46][3]; ?></a></td>                                                    
                                                    </tr>
                                                    <tr>
                                                        <th scope="row">4</th>
