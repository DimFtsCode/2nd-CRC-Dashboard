...
<html>
    <head>        
        ...
        echo("<link rel=\"stylesheet\" type=\"text/css\"  href=\"../styles/style_seep0.css?v=" .rand() . "\">" );        
        ?>
    ...
    <body>
        <div id="container">
            <div id="header">
                <h1> 2o AKE / ΣΜΗΝΟΣ ΕΠΙΤΕΛΕΙΟΥ ΕΞΥΠΗΡΕΤΗΣΗΣ ΠΡΟΣΩΠΙΚΟΥ </h1>
            </div> <!-- end header -->
            <div id="menu">
                <ul>
            ...
            <div id="mainContainer">
                ...
                <div id="leftbar">
                    <h3> <span style="text-decoration: underline; color: red;"> ΓΕΝΙΚΑ </span> </h3>
                    <ul>
                    ...
                    <h3> <span style=" text-decoration: underline; color: red;"> ΥΠΟΣΤΗΡΙΞΗ </span> </h3>
                    <ul>
                ...
                <div id="content">
                    <h2> <span style="text-align: center; text-decoration: underline; color: red;"> ΣΜΗΝΟΣ ΕΠΙΤΕΛΕΙΟΥ ΕΞΥΠΗΡΕΤΗΣΗΣ ΠΡΟΣΩΠΙΚΟΥ </span> </h2>
                    
                    <p style="color: blue; width: 90%; font-size: large"> Το Σμήνος Επιτελείου Εξυπηρέτησης Προσωπικού στο 2ο ΑΚΕ έχει ως κύριο έργο ......  </p> 
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="custom"> <a href="../web/seep/useful"> <span style="color: black; background-color: yellow; "> Διάφορα / Χρήσιμα </span></a> </td> 
