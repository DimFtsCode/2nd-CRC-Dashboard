    ...
    <body>
        ...
        <div id="wrapper">
           ...
           <div class="panel-heading text-center">
                        <div class="col-lg-12">
                            <h1 class="page-header" style="color: red;"> 2o AKE Προβολή Προσωπικού // ΟΒΑ - ΣΤΡΑΤΕΥΣΙΜΟΙ --- <?php echo date("j - m - Y"); ?></h1>
                        </div>
                        <!-- /.col-lg-12 -->
             </div>     
            ...
            <div class="panel-body">
                <div cla    ss="dataTables_wrapper">
                    ...
                    require_once("../php_functions/functions.inc");
                    $class = "table";
                    $headArray = array("SN", "ΑΣΜΑ", "Βαθμός", "Ειδ.", "Επιθετο", "Ονομα", "Διεύθυνση", "Τμήμα/Σμήνος", "Παρουσίαση", "Διαγραφή/Απόλυση");
                    ...
                    $sql = "SELECT personnel.*, divisions.description AS My_DIV, branches.branch as MyBranch, ranks.* FROM personnel, divisions, branches, ranks WHERE personnel.division = divisions.id  AND personnel.branch=branches.id AND ranks.rank=personnel.rank AND personnel.unit ='{$myUnit}' AND (personnel.rank ='{$myRank}' OR personnel.rank ='{$myRank2}') ORDER BY ranks.priority ASC, personnel.asma ASC";
                    $db = new DbMgmt;
                    $res = $db->runQuery($sql);
                    $serial = 1;
