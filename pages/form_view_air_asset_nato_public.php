...
<html lang="en">
    ...
    <body>
        <div id="container">
            <div id="header">
                <h1> CRC PARNIS / OPS SQUADRON -- Fighter's Readiness Status </h1>
...
<!--                    <li><a href="./form_view_air_delta_public.php"> ΔΕΛΤΑ</a> </li>-->
...
<!--                    <li><a href="../index.php">Home</a></li>  -->
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="panel panel-default">
                                        <div class="panel-heading text-center">
                                            <strong> Fighter's Readiness Status - <?php echo date("j - m - Y"); ?> ---- </strong>
                                        ...
                                        <div class="panel-heading text-right">
                                            ...
                                            //echo "<strong class=\"stat_nato\" style=\"background-color: yellow;\"> <a href=\"./form_view_air_delta_public.php\">" . " Next "  .  " </a> </strong>"; 
        ...
        <script src="../js/form_view_air_asset_nato.js"></script>
