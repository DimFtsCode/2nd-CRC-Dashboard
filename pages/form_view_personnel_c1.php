                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="dataTables_wrapper">
                                            ...
                                            $class = "table";
                                            $headArray = array("ΑΣΜΑ", "Βαθμός", "Ειδ.", "Επιθετο", "Ονομα", "Διεύθυνση");
                                            ...
                                            $sql = "SELECT personnel.*, divisions.description AS My_DIV FROM personnel, divisions WHERE personnel.division = divisions.id AND personnel.password='{$myPassword}' ORDER BY personnel.asma ASC";
                                            $db = new DbMgmt;                                            
                                            $res = $db->runQuery($sql);
