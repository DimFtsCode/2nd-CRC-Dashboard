...
<html>
    <head>        
        ...
        echo("<link rel=\"stylesheet\" type=\"text/css\"  href=\"../styles/style_dee0.css?v=" .rand() . "\">" );        
        ?>
    ...
    <body>
        <div id="container">
            <div id="header">
                <h1> 2o AKE / ΔΙΕΥΘΥΝΣΗ ΕΠΙΧΕΙΡΗΣΕΩΝ ΕΚΠΑΙΔΕΥΣΗΣ & ΠΡΟΣΤΑΣΙΑΣ ΔΥΝΑΜΕΩΝ </h1>
            </div> <!-- end header -->
            <div id="menu">
                <ul>
                    ...
                    <li><a href="" target="_blank">TBD .. </a></li>
            ...
            <div id="mainContainer">
                ...
                <div id="leftbar">
                    <h3> <span style="text-decoration: underline; color: red;"> ΕΘΝΙΚΑ </span> </h3>
                    <ul>
                    ...
                    <h3> <span style=" text-decoration: underline; color: red;"> NATO </span> </h3>
                    <ul>
                ...
                <div id="content">
                    <h2> <span style="text-align: center; text-decoration: underline; color: red;"> ΔΙΕΥΘΥΝΣΗ ΕΠΙΧΕΙΡΗΣΕΩΝ ΕΚΠΑΙΔΕΥΣΗΣ & ΠΡΟΣΤΑΣΙΑΣ ΔΥΝΑΜΕΩΝ  </span> </h2>
                    
                    <p style="color: blue; width: 90%; font-size: large"> Η Διεύθυνση Επιχειρήσεων Εκπαίδευσης & Προστασίας Δυνάμεων του 2ου ΑΚΕ έχει ως κύρια αποστολή .....  </p> 
                    ...
                    <table>
                        ...
                        <tr>
                            <td class="code"> <a href="../web/dee/org"> <span style="color: black; background-color: yellow; "> ΘΕΣΜΙΚΑ ΚΕΙΜΕΝΑ </span></a> </td>                                                   
                            <td class="custom"> <a href="../web/dee/useful"> <span style="color: black; background-color: yellow; "> Διάφορα / Χρήσιμα </span></a> </td> 
                            <td class="sideR"> <a href="../web/dee/prs"> <span style="color: black; background-color: yellow; "> #~ ΥΠΗΡΕΣΙΕΣ ΑΜΥΝΑΣ ΦΡΟΥΡΗΣΗΣ </span></a> </td>
                        </tr>
                        <tr>
                            <td class="code"> <a href="../web/dee/mdm"> <span style="color: black; background-color: cyan; "> ΜΟΝΙΜΕΣ ΔΙΑΤΑΓΕΣ ΜΟΝΑΔΑΣ</span></a> </td>                              
                        ...
                        <tr>
                            <td class="code"> <a href="../web/dee/jobds"> <span style="color: black; background-color: orange; "> JOB Descriptions </span></a> </td> 
                        ...
                        <tr>
                            <td class="code"> <a href="../web/dee/nato"> <span style="color: black; background-color: green; "> NATO Documentation </span></a> </td>
                        ...
                        <tr>
                            <td class="custom"> <a href="../web/dee/checklists"> <span style="color: black; background-color: yellow; "> Μνημόνια - CheckLists </span></a> </td>  
                        ...
                        <tr>
                            <td class="code"> <a href=""> <span style="color: red; background-color: yellow; "> ...TBD </span></a> </td>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="photo"> <img src="../web/images/misc/IMG_20230609_182052.jpg" alt=""  height=100 width=150> </td>                          
                            <td class="photo"> <img src="../web/images/misc/20230212_071551.jpg" alt=""  height=100 width=180> </td>
                            <td class="photo"> <img src="../web/images/misc/20230516_132517.jpg" alt=""  height=100 width=180> </td>
                        </tr>
                        <tr>
                            <td class="photo"> Ops Room #1 </td>
                            <td class="photo"> ΚΕΠΙΧ </td>
                            <td class="photo"> Parnis </td>
