...
<html lang="en">
    ...
    <head>
        ...
        <title> Form View Next PGR Leaves </title>   
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        <div id="container">
            <div id="header">
                <h1 style="color: red;"> 2o AKE -- Προβολή  Επικείμενων Προγραμματισμένων Αδειών Προσωπικού </h1>
            </div> <!-- end header -->
            <div id="menu">
                <ul>
                                        ...
                                        <div class="col-sm-2">
                                          ...
                                          <div class="panel-body">
                                            <div class="dataTables_wrapper">
                                                ...
                                                $class = "table";
                                                $headArray = array("SN", "ID", "ASMA", "ΒΑΘΜΟΣ", "ΕΙΔ",  "ΕΠΙΘΕΤΟ",  "ΟΝΟΜΑ", "DATE", "Num", "Leave_type", "Location", "REG_date", "REM");
                                                $head = count($headArray);
                                                $Scope = "LIVE";

                                                //$sql = "SELECT leaves.*, personnel.*, leave_type.id, leave_type.description as My_type FROM leaves, personnel, leave_type WHERE personnel.asma=leaves.asma AND leaves.leave_type = leave_type.id ORDER BY start_date ASC";
                                                $sql = "SELECT pgrleave.*, personnel.*, leave_type.id, leave_type.description as My_type FROM pgrleave, personnel, leave_type WHERE personnel.asma=pgrleave.pl_asma AND pgrleave.leave_type = leave_type.id ORDER BY start_date ASC";
                                                ...
                                                while ($row_air = mysqli_fetch_array($res)) {
                                                   ...
                                                   //$diff = ceil(abs($Curdate - $CheckDate1) / 86400);
        ...
        <script src="../js/form_view_current_pgrleaves.js"></script>
