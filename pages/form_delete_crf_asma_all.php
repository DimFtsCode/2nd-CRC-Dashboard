...
<html lang="en">
    ...
    <head>
        ...
        <title> Form Delete All CRF from User </title>
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                        ...
                        <span class="icon-bar"></span>y
                        <span class="icon-bar"></span>
                        <span class="icon-bar"></span>
                    </button>
                    <a class="navbar-brand" href="#"> <strong style="color: red; "> Delete All CRF Files from User </strong> </a>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Διαγραφή Όλων των CRF Αρχείων από  Χρήστη </h1>
                        </div>
                    ...
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_delete_crf_asma_all" class="form-horizontal" action="../php_functions/delete_crf_asma_all.php" method="POST" >                          
                            ...
                            <div class="form-group">                       
                                <label class="col-sm-4 control-label">ΕΠΙΛΕΞΕ ΑΣΜΑ : </label>                            
                            </div>                                                         
        ...
        <script type="text/javascript" src="../js/delete_crf_asma_all.js"></script>
