...
<html lang="en">   
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" >
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; ">  View Signed CRF Files </strong> </a>
                    <a class="navbar-brand" href="dashboard.php"> <strong style="color: blue; ">  Dashboard   </strong> </a>   
                    <a class="navbar-brand" href="./form_view_us_crfiles_user.php"> <strong style="color: darkred; ">  Προβολή Ανυπόγραφων </strong> </a>
            ...
            <div class="panel-heading text-center">
                        <div class="col-lg-12">
                            <h1 class="page-header" style="color: red;"> Προβολή Υπογεγραμένων  CRF Files --- <?php echo date("j - m - Y"); ?></h1>
                        </div>
                        <!-- /.col-lg-12 -->
             </div> 
            ...
            <div class="panel-body">
                <div class="dataTables_wrapper">
                    ...
                    $class = "table";
                    $headArray = array("SN", "File ID", "ΠΕΡΙΓΡΑΦΗ", "ΕΤΟΣ", "Path", "UnSign", "File Signed on :");
                    $head = count($headArray);
                    //$myUnit = "1ΑΚΕ";
                                        
                    $sql = "SELECT crf.*, crfiles.* FROM crf, crfiles WHERE crf.asma='{$asma}'  AND crf.fid = crfiles.fid  AND crf.sign = '{$sign}' ORDER BY crfiles.fyear DESC, crfiles.fid DESC";
                    ...
                    while ($row = mysqli_fetch_array($res)) {
                        ...
                        echo "<td class=\"sign_id\"> <a class=\"btn btn-outline btn-primary\" >" . "UnSign the Document" ."  </a> </td>";
        ...
        <script type="text/javascript" src="../js/form_view_sn_crfiles_user.js"></script>
