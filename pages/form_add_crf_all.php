...
<html lang="en">
    ...
    <head>
        ...
        <title> Form Add CRF to All </title>
        <!-- Bootstrap Core CSS -->
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; "> Add CRF Files to ALL </strong> </a>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Προσθήκη CRF Αρχείου στο Σύνολο του Προσωπικού </h1>
                        </div>
                    ...
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_add_crf_all" class="form-horizontal" action="../php_functions/add_crf_all.php" method="POST" >
                            ...
                            <div class="form-group">                       
                                <label class="col-sm-2 control-label">ΕΠΙΛΕΞΕ ΕΓΓΡΑΦΟ : </label>                            
<!--                                <div class="col-sm-2">
        ...
        <script type="text/javascript" src="../js/add_crf_all.js"></script>
