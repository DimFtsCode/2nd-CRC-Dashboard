...
<html>
    <head>        
        ...
        echo("<link rel=\"stylesheet\" type=\"text/css\"  href=\"../styles/style_ydktis0.css?v=" .rand() . "\">" );        
        ?>
        ...
        <div id="container">
            ...
            <div id="menu">
                <ul>
                    ...
                    <li><a href="./dktis_init0.php">ΔΚΤΗΣ</a></li>
            ...
            <div id="mainContainer">
                ...
                <div id="content">
                    <h2> <span style="text-align: center; text-decoration: underline; color: red;"> ΥΠΟΔΙΟΙΚΗΤΗΣ  </span> </h2>
                    
                    <p style="color: blue; width: 90%; font-size: large"> " Τον Άρχοντα τριών δει μέμνησθαι : Πρώτον ότι ανθρώπων άρχει. Δεύτερον ότι κατά νόμους άρχει.Τρίτον ότι ουκ αεί άρχει ..."  </p> 
                    ...
                    <table>
                        ...
                        <tr>
                            <td class="code"> <a href="../web/ydktis/maps"> <span style="color: black; background-color: yellow; "> Χάρτες Περιοχής 2ου ΑΚΕ </span></a> </td>                                                    
                            <td class="custom"> <a href="../web/ydktis/useful"> <span style="color: black; background-color: yellow; "> Διάφορα / Χρήσιμα </span></a> </td> 
                            <td class="sideR"> <a href="../web/ydktis/kepix"> <span style="color: black; background-color: yellow; "> #~ Ενημέρωσεις / Πίνακες ΚΕΠΙΧ </span></a> </td>
                        </tr>
                        <tr>
                            <td class="code"> <a href="../web/ydktis/nomoi"> <span style="color: black; background-color: yellow; "> ΝΟΜΟΙ - ΦΕΚ </span></a> </td>                           
                        ...
                        <tr>
                            <td class="code"> <a href="../web/ydktis/support"> <span style="color: yellow; background-color: orangered; "> SUPPORT </span></a> </td>
                        ...
                        <tr>
                            <td class="code"> <a href="../web/ydktis/ops"> <span style="color: red; background-color: cyan; "> Current OPS - EX </span></a> </td>
                        ...
                        <tr>
                            <td class="custom"> <a href="../web/ydktis/checklists"> <span style="color: black; background-color: yellow; "> Εγχειρίδια - CheckLists </span></a> </td>  
                        ...
                        <tr>
                            <td class="code"> <a href="../web/ydktis/prs"> <span style="color: red; background-color: yellow; "> ΠΡΟΣΩΠΙΚΟ </span></a> </td>
                    ...
                    <table>
                        ...
                        <tr>
                            <td class="photo"> <img src="../web/images/Parnis_HQ1.jpg" alt=""  height=100 width=150> </td>
