...
<html lang="en">   
    ...
    <head>
        ...
        <title> Form View Major by Date2 </title> 
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" >
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red;">  View Major Sum of Events </strong> </a>
                    ...
                    <a class="navbar-brand" href="./form_add_major.php"> <strong style="color: blue; "> Εισαγωγή Συμβάντος   </strong> </a>                                         
                    <?php
                    $myHerf = " <a class=\"navbar-brand\" style=\"color: red;\" href=\"../web/videos/MajorEvents3.mp4\"> <strong> Εισαγωγή Συμβάντος (Βοήθεια) </strong> </a> ";
                    if ($user->role == "SYS" || $user->role == "CMD" || $user->role3 == "MAJOR") {
                        echo $myHerf;
                    }
                    ?>                   
           ...
           <div class="panel-heading text-center">
                        <div class="col-lg-12">                            
                             <h1 class="page-header" style="color: blue;"> Προβολή Συνόλου Σημαντικών Συμβάντων --- <?php echo date("j - m - Y"); ?> </h1>
                        </div>                        
            </div>                    
            ...
            <div class="panel-body">
                <div class="dataTables_wrapper">
                    ...
                    $class = "table";
                    //$myDate = "2022-12-20";
                    $headArray = array("SN", "ID", "ΤΟΜΕΑΣ", "ΚΑΤΗΓΟΡΙΑ", "ΠΕΡΙΓΡΑΦΗ", "LINK /PATH" , "ΕΝΑΡΞΗ" , "ΠΕΡΑΣ", "USER", "DEL" );
                    $head = count($headArray);   
                    
                    $sql = "SELECT major.* FROM major ORDER BY date_start DESC";
                    ...
                    while ($row = mysqli_fetch_array($res)) {
                        ...
                        if ($user->role == "SYS" || $user->role == "CMD" || $user->role3 == "MAJOR") {
                          echo "<td class=\"mjid\" > <a href=\"./form_edit_major.php\" >" . "<strong style=\"color: blue; font-size: 16px;\">" . $row['mjid'] . "</strong>". " </a> </td>";   
                        } else {
                          echo "<td class=\"mjid\" > <a href=\"#\" >" . "<strong style=\"color: blue; font-size: 16px;\">" . $row['mjid'] . "</strong>". " </a> </td>";   
                        }
                        ...
                        echo "<td class=\"link\" > <a href=\" " . $row['link'] . "\"  >" . "<strong style=\"color: blue; font-size: 16px;\">" . $row['link'] . "</strong>". " </a> </td>";
                        
                        echo "<td>" . $row['date_start'] . "</td>";                          
                        echo "<td >" . $row['date_end'] . "</td>";                        
                        echo "<td >" . $row['user_reg'] . "</td>";
                        
                        //echo "<td class=\"mjid_del\" > <a href=\"./form_delete_major.php\" >" . "<strong style=\"color: blue; font-size: 16px;\">" . $row['mjid'] . "</strong>". " </a> </td>"; 
                        if ($user->role == "SYS" || $user->role3 == "CMDR") {
                        
                            echo "<td class=\"mjid_del\" > <a href=\"./form_delete_major.php\" >" . "<strong style=\"color: blue; font-size: 16px;\">" . $row['mjid'] . "</strong>". " </a> </td>";
                        } else {
                           echo "<td class=\"mjid_del\" > <a href=\"\" >" . "<strong style=\"color: blue; font-size: 16px;\">" . $row['mjid'] . "</strong>". " </a> </td>"; 
                        }
                        echo "</tr>";
                        $serial = $serial + 1;
                    }
        ...
        <script type="text/javascript" src="../js/form_view_major_bydate.js"></script>  
