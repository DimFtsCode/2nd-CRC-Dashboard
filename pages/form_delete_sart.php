        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0"> 
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; "> Delete SART </strong> </a>
                </div>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Διαγραφή Εγγραφής Κατάστασης Α/Δ </h1>                             
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_delete_sart" class="form-horizontal" action="../php_functions/sart_delete.php" method="POST">                           
...
<!--                                <button type="button" id="btn_delete" name ="btn_delete" style="background-color: yellow" style="font-size: larger"> Delete Record </button>-->
                                <span id="delete_btn" style="background-color: red"> You must select a SART prior to DELETE it ! </span>                                                            
                            </div>    
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select class="form-control"  id="sart_id" name="sart_id" required="sart_id" readonly >
                                        <option value="" selected disabled> SART id </option>
                                        <?php
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">                                    
                                    <select class="form-control" id="status" name="status" required="status" readonly>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-4">
                                    <button type="submit" class="btn btn-default" id="submit" name="submit" style="font-size: x-large"> Delete SART </button>
                                    <span id="delete_btn" style="background-color: red"> Are you sure ?? DELETE the SART ?? </span>
                                </div>
                            </div>
        ...
        <script type="text/javascript" src="../js/delete_sart.js"></script> 
