...
<html lang="en">
    ...
    <head>
        ...
        <title> Form Edit TR Folder </title>
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; "> Edit Training Folder </strong> </a>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Διόρθωση Στοιχείων Φακέλου Εκπαίδευσης </h1>
                        </div>
                    ...
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_add_tpye_asma" class="form-horizontal" action="../php_functions/trfolder_edit.php" method="POST">
                            <div id="errorDiv"> 
                                <?php
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"> Φάκελος Eκπαίδευσης: </label>
                                <div class="col-sm-4">                                    
                                    <select class="form-control" id="trfolder_yn" name="trfolder_yn" >
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"> Θέση Φακέλου ΕΚΠ: </label>
                                <div class="col-sm-4">
                                    <input type="text" id="trfolder_loc" name="trfolder_loc" class="form-control" placeholder="trfolder_loc">
        ...
        <script type="text/javascript" src="../js/edit_trfolder_asma.js"></script>
