...
<html lang="en">
    ...
    <head>
        ...
        <title> Form Insert New Log </title> 
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; "> Insert New Log Record  </strong> </a>
                </div>
            ...
            <div id="page-wrapper">
                <div class="container-fluid"> 
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Εισαγωγή Νέας Εγγραφής στο Ημερολόγιο ΚΕΠΙΧ </h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_add_logbook" class="form-horizontal" action="../php_functions/logbook_insert.php" method="POST">   
                            ...
                            <div class="form-group">
                                <legend class="col-sm-2 control-label"> Log Information  </legend>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date col-sm-2" >
                                    ...
                                    ?>     
                                    <button type="button" id="set_time" name ="set_time" style="background-color: green" style="font-size: larger">Set Now</button>
                                </div>
                                
                            </div>                                                        
                                     
                            <div class="form-group">
                                <label class="col-sm-2 control-label"> Load Value : </label>
                                <div class="col-sm-2">                                    
                                    <select class="form-control" id="load" name="load" required="load">
                                        <option value="" selected disabled> Load Value </option>
                                        <option class="text-primary" value="1">NORMAL / LOW</option>
                                        <option class="text-primary" value="2">MEDIUM</option>  
                                        <option class="text-primary" value="3">HIGH</option>
                                    </select>                                          
                                </div>
                            </div>
        ...
        <script type="text/javascript" src="../js/add_logbook.js"></script>
