    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div class="panel-heading text-center">
                <strong>Προβολή Προσωπικού - <?php echo date("j - m - Y"); ?></strong>
            </div>
            <div class="panel-body">
                <div class="dataTables_wrapper">
                    ...
                    $class = "table";
                    $headArray = array("SN", "ΑΣΜΑ", "Βαθμός", "Ειδ.", "Επιθετο", "Ονομα");
                    ...
                    //$sql = "SELECT personnel.*, divisions.description AS My_DIV, ranks.* FROM personnel, divisions, ranks WHERE personnel.division = divisions.id AND ranks.rank=personnel.rank  AND personnel.unit ='{$myUnit}'  ORDER BY ranks.priority ASC, personnel.asma ASC";
                    $sql = "SELECT personnel.*, divisions.description AS My_DIV, ranks.*, prsdata.* FROM personnel, divisions, ranks, prsdata WHERE personnel.asma=prsdata.asma AND personnel.division = divisions.id AND ranks.rank=personnel.rank  AND personnel.unit ='{$myUnit}'  ORDER BY ranks.priority ASC, personnel.asma ASC";
                    ...
                    while ($row_personnel = mysqli_fetch_array($res)) {
                        ...
                        echo "<td class=\"asma\" > <a href=\"./form_edit_pgr_leave.php\" >" . "<strong>" . $row_personnel['asma'] . "</strong>". " </a> </td>";
