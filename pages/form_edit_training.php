...
<html lang="en">
    ...
    <head>
        ...
        <title> Form Edit Personnel Training </title>
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; "> Edit Personnel Training</strong> </a>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Διόρθωση Σχολείου Προσωπικού </h1>
                        </div>
                    ...
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_edit_training" class="form-horizontal" action="../php_functions/training_edit.php" method="POST">
                            <div id="errorDiv"> 
                                <?php
        ...
        <script type="text/javascript" src="../js/edit_training.js"></script>
