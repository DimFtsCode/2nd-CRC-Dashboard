...
<html lang="en">   
    ...
    <head>
        ...
        <title> Form Add Personnel by Division</title> 
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" >
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red;"> Add Security Car Data by Division </strong> </a>
           ...
           <div class="panel-heading text-center">
                        <div class="col-lg-12">                            
                             <h1 class="page-header" style="color: red;"> Εισαγωγή Στοιχείων Ασφαλείας Οχημάτων / Επιστασία --- <?php  echo  "<strong style=\"color: black; font-size: 40px; background-color: yellow;\">" .  $myDivision . "</strong>"; ?>  ---- <?php echo date("j - m - Y"); ?> </h1>
                        </div>                        
             </div>     
                ...
                <div class="dataTables_wrapper">
                    ...
                    while ($row_personnel = mysqli_fetch_array($res)) {
                        ...
                        echo "<td class=\"serial\">" . $serial . "</td>";
                         ...
                         echo "<td class=\"asma\" > <a href=\"./form_add_secmoto_asma.php\" >" . "<strong style=\"color: blue; font-size: 16px;\">" . $row_personnel['asma'] . "</strong>". " </a> </td>";
        ...
        <script type="text/javascript" src="../js/form_add_secmoto_bydiv.js"></script>  
