...
$myAsma = $user->asma;
$myIndex = $myAsma . "SECDATA";
$mySecData = $_SESSION[$myIndex];
...
<html lang="en">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Διόρθωση Στοιχείων Ασφαλείας Προσωπικού </h1>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">       
                                 ...
                                 <input type="text" id="mySecData" name="mySecData" class="form-control" style="display:none" value="<?php echo $mySecData?>"  >                                  
                            </div>
                        </div>   
                    ...
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_edit_event" class="form-horizontal" action="../php_functions/security_edit.php" method="POST">
                            <div id="errorDiv"> 
                                <?php
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">SecData ID : </label>
                                <div class="col-sm-2">
                                    <input type="text" id="secid" name="secid" class="form-control" placeholder="SecData ID" readonly>                                    
                                </div>
                            </div>    
                            ...
                            <div class="form-group">
                                ...
                                <div  class="input-group date col-sm-2" >
                                    <input type="text" id="expdate" name="expdate" class="form-control date datepicker" required >
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                </div>
                            </div> 
                            
                             <div class="form-group">
                                <label class="col-sm-2 control-label"> Ηλεκτρονική Κάρτα (OPS Room) : </label>
                                <div class="col-sm-4">
                                    <input type="text" id="eid" name="eid" class="form-control" placeholder="electronic card number" >                                    
                                </div>
                            </div>
                            
                            <div class="form-group">
                                <label class="col-sm-2 control-label">ΒΑΘΜΟΣ ΑΣΦΑΛΕΙΑΣ : </label>
                                <div class="col-sm-4">

                                    <select class="form-control"  id="seclevel"  name="seclevel" required>
                                        <option value="" selected disabled> Βαθμός Ασφαλείας </option>
                                        <?php
                                        require_once '../php_functions/db_config/db_connect.php';
                                        $db = new DbMgmt;
                                        $sql = "SELECT * FROM seclass ORDER by cid ASC";                                        
                                        $cid = $db->runQuery($sql);
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"> ΠΡΟΣΒΑΣΗ ΣΕ : </label>
                                <div class="col-sm-4">
                                    <input type="text" id="access" name="access" class="form-control" placeholder="access" required>                                    
                                </div>
                            </div> 
                            
                            <div class="form-group">
                                <label class="col-sm-2 control-label">SECURITY CLEARANCE : </label>
                                <div class="col-sm-4">

                                    <select class="form-control"  id="clearance"  name="clearance" >
                                        <option value="" selected disabled> clearance class </option>
                                        <?php
                                        require_once '../php_functions/db_config/db_connect.php';
                                        $db = new DbMgmt;
                                        $sql = "SELECT * FROM seclass ORDER by cid ASC";                                        
                                        $cid = $db->runQuery($sql);
                                        while ($row = mysqli_fetch_array($cid)) {
                                            echo "<option value=\"" . $row['nato'] . "\">" . $row['nato'] . "</option>";
                                        }
                                        ?>                                        
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"> CLEARANCE EXPIRATION : </label>
                                <div  class="input-group date col-sm-2" >
                                    <input type="text" id="expclear" name="expclear" class="form-control date datepicker"  >
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                </div>
                            </div>   
                    ...
                    <div class="panel-body text-justify">
                        <?php
                            ...
                            echo "<strong class=\"photo\" ;\"> <img src=\"../web/dee/images/classified.jpg\" alt=\"\"  height=1000 width=600> </strong>";
        ...
        <script type="text/javascript" src="../js/edit_secdata_asma.js"></script>
