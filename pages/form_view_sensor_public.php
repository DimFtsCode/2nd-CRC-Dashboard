...
<html lang="en">
    ...
    <body>
        <div id="container">
            <div id="header">
                <h1> 2o AKE / Μοίρα Επιχειρήσεων -- Προβολή RADAR Status </h1>
...
<!--                    <li><a href="./form_view_sensor_public.php"> RADARs </a> </li>-->
                    <li><a href="./form_view_radio_public.php"> ΑΣΥΡΜΑΤΟΙ#1 </a> </li>
                    <li><a href="./form_view_tdl_public.php"> TDLs </a> </li>
                    <li><a href="./form_view_hotline_public.php"> HOTLINEs </a> </li>
...
<!--                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="panel panel-default">
                                        <div class="panel-heading text-center">
                                            ...
                                            <strong> ------ </strong>
                                             <strong><a href="./form_view_radio_public.php">Next</a></strong>
                                        </div>
                                        <!--                                    <div class="panel-heading text-center">
                                        ...
                                        <div class="panel-body">
                                            <div class="dataTables_wrapper">
                                                ...
                                                $class = "table";
                                                $headArray = array("SN", "ID", "SENSOR NAME", "TYPE", "STATUS", "REASON / REMARKS", "ACTIONS", "DATE", "by_USER", "DATE_REG",);
                                                ...
                                                while ($row_radar = mysqli_fetch_array($res)) {
                                                    ...
                                                    ///if ($user->role == "SYS" || $user->role == "ADP" || $user->role == "OPS") {
                                                   ...
                                                   // } else {
                                                        ...
                                                        //echo "<td class=\"sensor_id\" > <a href=\" " . $radar_path . "\" target=\"_blank\" >" . "<strong style=\"color: blue; font-size: 16px;\">" . $row_radar['sensor_id'] . "</strong>". " </a> </td>";
                                                   // }
                                                    //echo "<td class=\"sensor_id\"> <a class=\"btn btn-outline btn-primary\" >" . $row_radar['sensor_id'] . "  </a> </td>";
                                                    //echo "<td class=\"sensor_id\"> <a class=\"btn btn-outline btn-primary\" data-toggle=\"modal\" data-target=\"#update" . "$sensor_id_parse[$loop_var]" . " \" >" . $row_radar['sensor_id'] . "  </a> </td>";                                                                                                     
                                                    ...
                                                    echo "<td class=\"reason\">" . $row_radar['reason'] . "</td>";
                                                    echo "<td class=\"action\">" . $row_radar['action'] . " </strong> </td>";
                                                    echo "<td class=\"tbc\">" . date("d-m-Y", strtotime($row_radar['tbc'])) . "</td>";
                                                    //echo "<td class=\"tbc\">" . $row_radar['tbc'] . "</td>";
                                                    echo "<td class=\"user_reg\">" . $row_radar['user_reg'] . "</td>";
                                                    echo "<td class=\"date_reg\">" . $row_radar['date_reg'] . "</td>";
                                                    echo "</tr>";
                                                    $loop_var = $loop_var + 1;
                                                    $serial = $serial + 1 ;
                                                }
                                        ...
                                        <div class="panel-heading text-right">
                                            <?php                                           
                                                echo "<strong class=\"stat_nato\" style=\"background-color: yellow;\"> <a href=\"./form_view_radio_public.php\">" . " Next "  .  " </a> </strong>";                                                                                     
                                            ?>
        ...
        <script src="../js/form_view_sensor_public.js"></script>
