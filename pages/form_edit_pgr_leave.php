...
//include("../php_functions/debug.php");
$user = new User;
if (!$user->isLoggedIn) {
...
<html lang="en">
    ...
    <head>
        ...
        <title> Form Edit PGR Leave </title>
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; "> Edit Leave  </strong> </a>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Προγραμματισμός Αδειών Προσωπικού </h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_edit_pgr_leave" class="form-horizontal" action="" method="POST">
                            <div id="errorDiv"> 
                                <?php
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" id="asma" name="asma" class="form-control" placeholder="asma" required="asma" value="<?php echo $user->asma; ?>"  readonly >                                                                          
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" id="rank" name="rank" class="form-control" placeholder="rank" required="rank" value="<?php echo $user->rank ; ?>" readonly>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" id="specialty" name="specialty" class="form-control" placeholder="specialty" required="specialty" value="<?php echo $user->splty ; ?>" readonly>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" id="last_name" name="last_name" class="form-control" placeholder="last_name" required="last_name" value="<?php echo $user->sname ; ?>" readonly>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" id="first_name" name="first_name" class="form-control" placeholder="first_name" required="first_name" value="<?php echo $user->fname ; ?>" readonly>
                                    <span class="errorFeedback errorSpan" id="first_nameError">First Name  should be only capital letters </span>
                                </div>
                            </div>                                                       
                                                                                        
                            <div class="panel-heading text-left">
                                            <strong style="color: black; font-size: 20px;"> ΠΡΟΓΡΑΜΜΑΤΙΣΜΟΣ ΑΔΕΙΩΝ  ---- </strong>
                                            <strong style="color: black; background-color: yellow;"> ΔΙΟΡΘΩΣΗ ΠΡΟΓΡΑΜΜΑΤΙΣΜΕΝΗΣ ΑΔΕΙΑΣ  </strong>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select class="form-control"  id="pl_id" name="pl_id" required="pl_id" readonly >
                                        <option value="" selected disabled> pl_id </option>
                                        <?php
                                        ...
                                        //$sql = "SELECT pgrleave.*, leave_type.id, leave_type.description as My_type FROM pgrleave, leave_type  WHERE pgrleave.pl_asma = $user->asma ORDER BY `pl_id` DESC ";
                                        $air_id = $db->runQuery($sql);
                                        while ($row_air = mysqli_fetch_array($air_id)) {
                                            echo "<option value=\"" . $row_air['pl_id'] . "\">" . $row_air['pl_id'] . " -- ". $row_air['start_date'] . " -- ". $row_air['num_days'] ." -- ". $row_air['My_type'] ."</option>";
                                        }
                                        ?>                                        
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">XID : </label>
                                <div class="col-sm-4">
                                    <input type="text" id="xid" name="xid" class="form-control" placeholder="xid" value="<?php $myVar = $user->asma;  $myVar = $myVar . "XID"; echo $_SESSION[$myVar] ?>" required="xid" >
                                    <span class="input-group-btn"><button class="btn btn-outline-secondary" type="button" id="btn_getdata" name ="btn_getdata">Get Data</button></span>                                    
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" id="location" name="location" class="form-control" placeholder="location" value="<?php  echo $user->asma; ?>" required="location" >
        ...
        <script type="text/javascript" src="../js/edit_pgr_leave.js"></script>
