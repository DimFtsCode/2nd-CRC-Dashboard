...
if (!($user->role == "SYS" || $user->role == "CMD" || $user->role3 == "CMDR")) { 
     die(header("Location: dashboard.php"));
 }
 
$myAsma = $user->asma;
$myIndex = $myAsma . "ASMA";
$myIndex2 = $myAsma . "MAJOR";
$myIndex3 = $myAsma . "DESCR";
$myUser = $_SESSION[$myIndex];
$myMajor = $_SESSION[$myIndex2];
$myDescript = $_SESSION[$myIndex3];
...
<html lang="en">
    ...
    <head>
        ...
        <title> Form Delete Major Event </title>
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; "> Delete Major Event </strong> </a>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Διαγραφή Σημαντικών Συμβάντων </h1>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">       
                                 ...
                                 <input type="text" id="myMajor" name="myMajor" class="form-control" style="display:none"  value="<?php echo $myMajor; ?>"  >
                            </div>
                        </div>   
                    ...
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_add_school_asma" class="form-horizontal" action="../php_functions/major_delete.php" method="POST">
                            <div id="errorDiv"> 
                                <?php
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" id="mjid" name="mjid" class="form-control" placeholder="Event ID" readonly>                                    
                                </div>
                            </div>                                
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">                                    
                                    <select class="form-control" id="scope" name="scope"  readonly>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select class="form-control"  id="type"  name="type"  readonly>
                                        <option value="" selected disabled> Είδος Συμβάντος </option>
                                        <?php
                                        require_once '../php_functions/db_config/db_connect.php';
                                        $db = new DbMgmt;
                                        $sql = "SELECT * FROM majortype ORDER by mtid ASC";                                       
                                        $etid = $db->runQuery($sql);
                                        while ($row = mysqli_fetch_array($etid)) {
                                            echo "<option value=\"" . $row['majortype'] . "\">" . $row['majortype'] . "</option>";
                                        }
                                        ?>                                        
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"> Περιγραφή :(Θα αναγράφεται η περιγραφή του συμβάντος, μέχρι 2048 χαρακτήρες.)  </label>
                                <div class="col-sm-4">
                                    <textarea  id="descript" name="descript" class="form-control" rows="10" placeholder="descript"  readonly><?php echo $myDescript; ?></textarea>                                   
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" id="link" name="link" class="form-control"   style="width: 900px;" placeholder="link" readonly>                                    
                                </div>
                            </div>  
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-4">
                                    <button id="submit" type="submit" class="btn btn-default">Delete Main Event</button>
                                </div>
                            </div>
        ...
        <script type="text/javascript" src="../js/delete_major.js"></script>
