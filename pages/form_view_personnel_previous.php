           ...
           <div class="panel-heading text-center">
            ...
            <div class="panel-body">
                <div cla    ss="dataTables_wrapper">
                    ...
                    //$sql = "SELECT personnel.*, ranks.* FROM personnel, ranks WHERE ranks.rank=personnel.rank  AND personnel.unit ='{$myUnit}' ORDER BY ranks.priority ASC, personnel.asma ASC";
                    $db = new DbMgmt;
                    $res = $db->runQuery($sql);
                    $serial = 1;
                    ...
                    while ($row_personnel = mysqli_fetch_array($res)) {
                        ...
                        echo "<td class=\"asma\" > <a href=\"./form_personnel_detail_info2.php\" target=\"_blank\">" . "<strong style=\"color: blue; font-size: 16px;\">" . $row_personnel['asma'] . "</strong>". " </a> </td>";
