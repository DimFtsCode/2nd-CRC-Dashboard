...
<html>
    <head>        
        ...
        echo("<link rel=\"stylesheet\" type=\"text/css\"  href=\"../styles/style_epit0.css?v=" .rand() . "\">" );        
        ?>
    ...
    <body>
        <div id="container">
            ...
            <div id="mainContainer">
                ...
                <div id="leftbar">
                    <h3> <span style="text-decoration: underline; color: red;"> ΓΡ. Τ-Α ΕΘΝΙΚΑ </span> </h3>
                    <ul>
                    ...
                    <h3> <span style=" text-decoration: underline; color: red;"> ΓΡ. Τ-Α ΝΑΤΟ </span> </h3>
                    <ul>
                ...
                <div id="content">
                    <h2> <span style="text-align: center; text-decoration: underline; color: red;"> ΕΠΙΤΕΛΕΙΟ  </span> </h2>
                    
                    <p style="color: blue; width: 90%; font-size: large"> ΤΑ ΑΦΑΝΗ ΤΟΙΣ ΦΑΝΕΡΟΙΣ ΤΕΚΜΑΙΡΟΥ .. </p> 
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="custom"> <a href="../web/epit/useful"> <span style="color: black; background-color: yellow; "> Διάφορα / Χρήσιμα </span></a> </td> 
                            <td class="sideR"> <a href="../web/epit/prs"> <span style="color: black; background-color: yellow; "> #~ Ενημέρωση Προσωπικού </span></a> </td>
                        </tr>
                        <tr>
                            <td class="code"> <a href=""> <span style="color: black; background-color: yellow; "> ... TBD </span></a> </td>                             
                        ...
                        <tr>
                            <td class="custom"> <a href="../web/xxx/checklists"> <span style="color: black; background-color: yellow; "> Εγχειρίδια - CheckLists </span></a> </td>  
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="photo"> <img src="../web/images/snow2.jpg" alt=""  height=100 width=150> </td>
                            <td class="photo"> <img src="../web/images/radar2.jpg" alt=""  height=100 width=150> </td>
                        </tr>
                        <tr>
                            <td class="photo"> Ops Room #1 </td>
                            <td class="photo"> ΠΑΝΟΡΑΜΙΚΗ </td>
                            <td class="photo"> ΕΚΧΙΟΝΙΣΤΙΚΟ </td>
