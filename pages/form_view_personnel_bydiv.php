    ...
    <body>
        ...
        <div id="wrapper">
           ...
           <div class="panel-heading text-center">
                        <div class="col-lg-12">                            
                             <h1 class="page-header" style="color: red;"> Προβολή Προσωπικού / Επιστασία --- <?php  echo  "<strong style=\"color: black; font-size: 40px; background-color: yellow;\">" .  $myDivision . "</strong>"; ?>  ---- <?php echo date("j - m - Y"); ?> </h1>
                        </div>                        
             </div>     
