        ...
        <div id="container">
            ...
            <div id="menu">
                <ul>
                    ...
                    <li><a href="" target="_blank">Βιβλιογραφία ΕΠΧ ΠΡΣ /ΑΤΑ </a></li>
            ...
            <div id="mainContainer">
                ...
                <div id="content">
                    ...
                    <table>
                        ...
                        <tr>
                            <td class="code"> <a href=""> <span style="color: black; background-color: yellow; "> Current OPS MIX </span></a> </td>                                                    
                        ...
                        <tr>
                            <td class="code"> <a href=""> <span style="color: black; background-color: yellow; "> Μνημόνια Ομάδας Όπλων </span></a> </td>                             
                        ...
                        <tr>
                            <td class="code"> <a href=""> <span style="color: black; background-color: yellow; "> Μνημόνια Ομάδας Επιτήρησης </span></a> </td>
                        ...
                        <tr>
                            <td class="code"> <a href=""> <span style="color: black; background-color: yellow; "> NATO Μνημόνια / SOPs </span></a> </td>
                        ...
                        <tr>
                            <td class="code"> <a href=""> <span style="color: red; background-color: yellow; "> ΣΧΕΔΙΑ </span></a> </td>
