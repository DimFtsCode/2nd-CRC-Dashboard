...
<html>
    <head>        
        <title> 2o AKE / Μοίρα Υποστήριξης </title>        
        <?php
        // The following is used to force the browser to clear cashe every time the page is loaded  
        echo("<link rel=\"stylesheet\" type=\"text/css\"  href=\"../styles/style_myp0.css?v=" .rand() . "\">" );        
        ?>
    ...
    <body>
        <div id="container">
            <div id="header">
                <h1> 2o AKE / Μοίρα Υποστήριξης </h1>
            </div> <!-- end header -->
            <div id="menu">
                <ul>
                    <li><a href="../index.php">Home</a></li>
                    <li><a href="" target="_blank">Εκδόσεις ICAO</a></li>
            ...
            <div id="mainContainer">
                ...
                <div id="leftbar">
                    <h3> <span style="text-decoration: underline; color: red;"> General </span> </h3>
                    <ul>
                    ...
                    <h3> <span style=" text-decoration: underline; color: red;"> Support </span> </h3>
                    <ul>
                ...
                <div id="content">
                    <h2> <span style="text-align: center; text-decoration: underline; color: red;"> Μοίρα Υποστήριξης </span> </h2>
                    
                    <p style="color: blue; width: 90%; font-size: large"> Η Μοίρα Υποστήριξης στο 2ο ΑΚΕ συγκροτήθηκε το Μαϊο του 2016, ......  </p> 
                    
                    <table>
                        <tr>
                            <th class="code"> Maintenance Documents </th>                            
                        ...
                        <tr>
                            ...
                            <td class="custom"> <a href="../web/myp/useful"> <span style="color: black; background-color: yellow; "> Διάφορα / Χρήσιμα </span></a> </td> 
                            <td class="sideR"> <a href="../web/myp/prs"> <span style="color: black; background-color: yellow; "> #~ Ενημέρωση Προσωπικού </span></a> </td>
                        </tr>
                        <tr>
                            <td class="code"> <a href=""> <span style="color: black; background-color: yellow; "> ... TBD </span></a> </td>                             
                        ...
                        <tr>
                            <td class="code"> <a href="../web/myp/routes"> <span style="color: black; background-color: yellow; "> ΔΡΟΜΟΛΟΓΙΑ ΜΟΝΑΔΑΣ </span></a> </td>
                        ...
                        <tr>
                            <td class="custom"> <a href="../web/myp/checklists"> <span style="color: black; background-color: yellow; "> Εγχειρίδια - CheckLists </span></a> </td>  
                        ...
                        <tr>
                            <td class="code"> <a href="../web/myp/diagram"> <span style="color: red; background-color: yellow; "> ΣΧΕΔΙΑΓΡΑΜΜΑΤΑ </span></a> </td>
                    ...
                    <table>
                        ...
                        <tr>
                            <td class="photo"> <img src="../web/images/misc/20230522_160304.jpg" alt=""  height=100 width=150> </td>
                            <td class="photo"> <img src="../web/images/misc/IMG_20230523_a.jpg" alt=""  height=150 width=150> </td>                          
                            <td class="photo"> <img src="../web/images/misc/IMG_20230530_104125.jpg" alt=""  height=100 width=150> </td>
                            <td class="photo"> <img src="../web/images/misc/20230522_114442.jpg" alt=""  height=100 width=150> </td>
                        </tr>
                        <tr>
                            <td class="photo"> Ops Room  </td>
                            <td class="photo"> Comms Room  </td>
                            <td class="photo"> Ops Room  </td>
                            <td class="photo"> Ops Room  </td>
                        </tr>
