    ...
    <body>
        <div id="container">
            ...
            <div id="mainContainer">
                ...
                <div id="content">
                    <h2> <span style="text-align: center; text-decoration: underline; color: red;"> ΕΠΙΣΤΑΣΙΑ ?  </span> </h2>
                    
                    <p style="color: blue; width: 90%; font-size: large"> Η Μοίρα xxxxxx ή Επιστασία some text , ......  </p> 
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="custom"> <a href="../web/xxx/useful"> <span style="color: black; background-color: yellow; "> Διάφορα / Χρήσιμα </span></a> </td> 
                            <td class="sideR"> <a href="../web/xxx/prs"> <span style="color: black; background-color: yellow; "> #~ Ενημέρωση Προσωπικού </span></a> </td>
                        </tr>
                        <tr>
                            <td class="code"> <a href=""> <span style="color: black; background-color: yellow; "> ... TBD </span></a> </td>                             
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="photo"> <img src="" alt=""  height=100 width=150> </td>                          
                            <td class="photo"> <img src="" alt=""  height=100 width=150> </td>
                            <td class="photo"> <img src="" alt=""  height=100 width=150> </td>
                        </tr>
                        <tr>
                            <td class="photo"> Ops Room #1 </td>
                            <td class="photo"> xxxxxxxxxx </td>
                            <td class="photo"> xxxxxxxxxx </td>
                            <td class="photo"> xxxxxxxxxx</td>
                        </tr>
