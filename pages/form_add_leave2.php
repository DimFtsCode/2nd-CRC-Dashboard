...
<html lang="en">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_add_leave" class="form-horizontal" action="../php_functions/leave_insert2.php" method="POST">
                            <div id="errorDiv"> 
                                <?php
        ...
        <script type="text/javascript" src="../js/add_leave2.js"></script>
