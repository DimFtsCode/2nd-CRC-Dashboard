...
<html lang="en">
    ...
    <head> 
        ...
        <title> Form Delete All PGR Leaves </title> 
        <!-- Bootstrap Core CSS -->
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0"> 
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; "> Delete All PGR Leaves </strong> </a>
                </div>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Διαγραφή Συνόλου Προγραμματισμένων Αδειών </h1>                             
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_delete_logbook" class="form-horizontal" action="../php_functions/pgr_leave_all_delete.php" method="POST">                           
...
<!--                                <button type="button" id="btn_delete" name ="btn_delete" style="background-color: yellow" style="font-size: larger"> Delete Record </button>-->
                                <span id="delete_btn" style="background-color: yellow"> Are you sure that you want  to DELETE all the Records ! </span>                                                            
                            </div>    
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-4">
                                    <button type="submit" class="btn btn-default" id="submit" name="submit" style="font-size: x-large"> Delete ALL PGR Leaves </button> 
                                    <div id="delete_btn" style="background-color: red" style="font-size: x-large"> ΜΕ ΑΥΤΗ ΤΗΝ ΕΝΕΡΓΕΙΑ ΘΑ ΔΙΑΓΡΑΦΟΥΝ ΟΛΕΣ ΟΙ ΠΡΟΓΡΑΜΜΑΤΙΣΜΕΝΕΣ  ΑΔΕΙΕΣ !! </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-4">    
                                    <?php
                                    if ($user->role == "SYS" || $user->role2 == "STAF+") {
                                        echo "<td class=\"alter_table\"> <a class=\"btn  btn-primary\" href=\"../php_functions/pgrleave_alter_table.php\" >" . "RESET TABLE" . " </a> </td>";
                                    } else {
