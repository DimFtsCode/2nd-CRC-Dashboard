...
$myAsma = $user->asma;
$myIndex = $myAsma . "ASMA";
$myIndex2 = $myAsma . "TPYE";
$myIndex3 = $myAsma . "TPYERM";
$myUser = $_SESSION[$myIndex];
$myTpye = $_SESSION[$myIndex2];
...
<html lang="en">
    ...
    <head>
        ...
        <title> Form Edit TPYE to Personnel </title>
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; "> Edit TPYE Personnel </strong> </a>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Διόρθωση Τακτικής Περιοδικής Υγ. Εξέτασης (ΤΠΥΕ) σε Προσωπικό </h1>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">       
                                 ...
                                 <input type="text" id="myTpye" name="myTpye" class="form-control"  style="display:none" value="<?php echo $myTpye;?>"  >
                            </div>
                        </div>   
                    ...
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_edit_tpye_asma" class="form-horizontal" action="../php_functions/tpye_edit.php" method="POST">
                            <div id="errorDiv"> 
                                <?php
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">ΤΠΥΕ ID : </label>
                                <div class="col-sm-2">
                                    <input type="text" id="tpid" name="tpid" class="form-control" placeholder="tpid" readonly>                                    
                                </div>
                            </div>  
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" id="rmknum" name="rmknum" class="form-control" placeholder="rmknum">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <textarea  id="message" name="remark" class="form-control" rows="4" placeholder="remark" text="dfgfdh" ><?php echo $myRemark; ?></textarea>
                                </div>
                            </div>
        ...
        <script type="text/javascript" src="../js/edit_tpye_asma.js"></script>
