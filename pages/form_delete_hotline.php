...
<html lang="en">
    ...
    <head>
        ...
        <title> Form Delete HOTLINE </title> 
        <!-- Bootstrap Core CSS -->
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0"> 
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; "> Delete HOTLINE </strong> </a>
                </div>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Διαγραφή HOTLINE </h1>                             
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_delete_hotline" class="form-horizontal" action="../php_functions/hotline_delete.php" method="POST">                           
...
<!--                                <button type="button" id="btn_delete" name ="btn_delete" style="background-color: yellow" style="font-size: larger"> Delete Record </button>-->
                                <span id="delete_btn" style="background-color: red"> You must select a HOTLINE prior to DELETE it ! </span>                                                            
                            </div>    
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select class="form-control"  id="line_id" name="line_id" required="line_id" readonly >
                                        ...
                                        while ($row_hotline = mysqli_fetch_array($line_id)) {
                                            echo "<option value=\"" . $row_hotline['line_id'] . "\">" . $row_hotline['line_id'] . " -- ". $row_hotline['line_name'] . "</option>";
                                        }
                                        ?>                                        
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" id="line_name" name="line_name" class="form-control" placeholder="line_name" required="line_name" readonly>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-4">
                                    <button type="submit" class="btn btn-default" id="submit" name="submit" style="font-size: x-large"> Delete HOTLINE</button>
                                    <span id="delete_btn" style="background-color: red"> Are you sure ?? DELETE the HOTLINE ?? </span>
                                </div>
                            </div>
        ...
        <script type="text/javascript" src="../js/delete_hotline.js"></script> 
