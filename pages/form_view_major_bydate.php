...
if (!($user->role == "SYS" || $user->role == "CMD" || $user->role3 == "MC" || $user->role3 == "SYSTEM")) { 
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" >
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red;">  View Major Events  by Date </strong> </a>
           ...
           <div class="panel-heading text-center">
                        <div class="col-lg-12">                            
                             <h1 class="page-header" style="color: blue;"> Προβολή Σημαντικών Συμβάντων --- <?php echo date("j - m - Y"); ?> </h1>
                        </div>                        
            </div>     
            
            <div class="panel-heading text-center">
                        <div class="col-lg-12">                            
                             <h3 class="page-header" style="color: red;"> Προβολή Σημαντικών Συμβάντων συγκεκριμένης Ημέρας  :  <?php echo $myDate; ?> </h3>
                        </div>                        
            </div>   
            ...
            <div class="form-group">
                            ...
                            <div class="form-row">                                                           
                                <div class="col-md-3 mb-3">
                                    <label class="col-sm-2 control-label"> Ημερομηνία </label>
            ...
            <div class="panel-body">
                <div class="dataTables_wrapper">
                    ...
                    $sql = "SELECT major.* FROM major WHERE (DATE(major.date_start) BETWEEN '{$myDate}' AND '{$myDate}') ORDER BY date_start DESC";
