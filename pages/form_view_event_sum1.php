        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" >
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="./form_view_event_current.php"> <strong style="color: darkred; "> Τρέχουσες Μεταβολές</strong> </a>
           ...
           <div class="panel-heading text-center">
                        <div class="col-lg-12">                            
                             <h1 class="page-header" style="color: blue;"> Προβολή Συνόλου Μεταβολών  Προσωπικού  --- <?php echo date("j - m - Y"); ?> </h1>
                        </div>                        
            </div>                 
            ...
            <div class="panel-body">
                <div class="dataTables_wrapper">
                    ...
                    $sql = "SELECT event.*, event.user_reg as MyUserReg, personnel.* FROM event, personnel WHERE personnel.asma = event.asma AND personnel.unit ='{$myUnit}' ORDER BY date_start DESC";
