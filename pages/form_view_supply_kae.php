...
<html lang="en">   
    ...
    <head>
        ...
        <title> Form View Supply KAE </title> 
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <div id="wrapper">
           ...
           <div class="panel-heading text-center">
                        <div class="col-lg-12">                            
                             <h1 class="page-header" style="color: blue;"> Προβολή Εντολών Αγοράς / Εργασίας Έτους :  <?php echo $DefYear; ?>  / KAE</h1>
                        </div>        
                        <div class="col-lg-12">                            
            ...
            <div class="panel-body">
                <div class="dataTables_wrapper">
                    ...
                    $sql = "SELECT * FROM supply WHERE year = '{$DefYear}' AND bcode = '{$myKAE}' ORDER BY serial DESC ";                    
       ...
       <!-- Modal Find User Information !! -->
        ...
        <script type="text/javascript" src="../js/form_view_supply_kae.js"></script>  
