...
if (!($user->role == "SYS" || $user->role == "CMD" || $user->role3 == "ASSIST")) { 
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; "> Upload Updates </strong> </a>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Upload Update to MainBoard </h1>
                        </div>
                    ...
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_upload_file" class="form-horizontal" action="../php_functions/upload_sfile2.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"> ΘΕΣΗ ΑΝΑΡΤΗΣΗΣ : </label>
                                <div class="col-sm-4">                                    
                                    <select class="form-control" id="fplace" name="fplace" required="fplace">
                                      <?php
                                        for ($arx = 1; $arx < 80; $arx++) {
