...
<html lang="en">   
    ...
    <head>
        ...
        <title> Form View Personnel Duty ΕΠΙΤ </title> 
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div class="panel-heading text-center">
                        <div class="col-lg-12">
                            <h1 class="page-header" style="color: red;"> Προβολή Καθηκόντων Προσωπικού ΕΠΙΤΕΛΕΙΟΥ --- <?php echo date("j - m - Y"); ?></h1>
                        </div>
                        <!-- /.col-lg-12 -->
             </div> 
            ...
            <div class="panel-body">
                <div class="dataTables_wrapper">
                    ...
                    $class = "table";
                    $headArray = array("SN", "ΑΣΜΑ", "Βαθμός", "Ειδ.", "Επιθετο", "Ονομα", "Επιστασία", "ΗΜΕΡΟΜ.", "ΚΑΘΗΚΟΝ#1", "ΗΜΕΡΟΜ.", "ΚΑΘΗΚΟΝ#2", "ΗΜΕΡΟΜ.", "ΚΑΘΗΚΟΝ#3");
