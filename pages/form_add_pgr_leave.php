...
<html lang="en">
    ...
    <head>
        ...
        <title> Form Add New PGR Leave </title>
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_add_pgr_leave" class="form-horizontal" action="../php_functions/pgr_leave_insert.php" method="POST">
                            <div id="errorDiv"> 
                                <?php
        ...
        <script type="text/javascript" src="../js/add_pgr_leave.js"></script>
