...
<html lang="en">
    ...
    <head>
        ...
        <title> Form View Missions </title>   
        <!-- Bootstrap Core CSS -->
        ...
        <link rel="stylesheet" type="text/css"  href="../styles/form_view_missions.css">
    ...
    <body>
        <div id="container">
            <div id="header">
                <h1> 2o AKE / Μοίρα Επιχειρήσεων -- Πίνακας Τακτικών Αποστολών </h1>
            </div> <!-- end header -->
            <div id="menu">
                <ul>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="panel panel-default">
                                        <div class="panel-heading text-center">
                                            <strong style="color: black; font-size: 20px;"> Πίνακας Τακτικών Αποστολών - <?php echo date("j - m - Y"); ?> ---- </strong>
                                            <strong style="color: black; background-color: yellow;"> ΑΣΚΗΣΕΙΣ - ΕΝΑΤΑΣΗ - ΠΟΛΕΜΟΣ  </strong>
<!--                                            <button type="button" id="btn_check" name ="btn_check" style="background-color: green" style="font-size: larger"> Delete Record </button>-->
                                        ...
                                        <div class="panel-body">
                                            <div class="dataTables_wrapper">
                                                ...
                                                require_once '../php_functions/db_config/db_connect.php';
                                                $class = "table";
                                                $headArray = array("SN", "ID", "ASSET", "CALLSIGN",  "TRACK", "MISSION", "FOE TRACK", "RESULTS", "AREA", "DATE", "TIME", "S / L", "REMARKS", "by_USER", "DEL");
                                                ...
                                                $sql = "SELECT * FROM missions ORDER BY mdate DESC, mtime DESC";
                                                $db = new DbMgmt;
                                                $res = $db->runQuery($sql);
                                                $serial = 1;
                                                echo "<table class=\"table table-striped table-bordered table-hover\" id=\"view_missions\">";
                                                ...
                                                while ($row_air = mysqli_fetch_array($res)) {
                                                    ...
                                                    if ($user->role == "SYS" || $user->role == "OPS" || $user->role2 == "OPS+") {                                                       
                                                        echo "<td class=\"mis_id\"> <a class=\"btn btn-outline btn-primary\" href=\"./form_edit_missions.php\" >" . $row_air['mis_id'] . " </a> </td>";                                                     
                                                    } else {                                                        
                                                        echo "<td class=\"mis_id\"> <a class=\"btn btn-outline btn-primary\" >" . $row_air['mis_id'] . "  </a> </td>";
                                                    }                                                                                                                                          
                                                    echo "<td class=\"asset\">" . $row_air['asset'] . "</td>";                                                    
                                                    echo "<td class=\"callsign\"> " . $row_air['callsign'] . "</td>";
                                                    echo "<td class=\"track\"> " . $row_air['track'] . "</td>";
                                                    $myIDmission = "mission" . $serial;
                                                    //echo "<td class=\"mission\"> " . $row_air['mission'] . "</td>"; 
                                                    echo "<td class=\"mission\" id=\"" . $myIDmission . "\"> " . $row_air['mission'] . "</td>";                                                    
                                                    
                                                    echo "<td class=\"track2\">" . $row_air['track2'] . "</td>";
                                                    echo "<td class=\"result\">" . $row_air['result'] . "</td>";
                                                    echo "<td class=\"area\">" . $row_air['area'] . "</td>";
                                                    echo "<td class=\"mdate\">" . $row_air['mdate'] . "</td>";
                                                    echo "<td class=\"mtime\">" . $row_air['mtime'] . "</td>";
                                                    $myIDScope = "scope" . $serial;
                                                    //echo "<td class=\"scope\">" . $row_air['scope'] . " </strong> </td>";
                                                    echo "<td class=\"scope\" id=\"" . $myIDScope . "\"> " . $row_air['scope'] . "</td>"; 
                                                    ...
                                                    if ($user->role == "SYS" || $user->role == "OPS" || $user->role2 == "OPS+") {                                                       
                                                        echo "<td class=\"mis_id\"> <a class=\"btn btn-outline btn-primary\" href=\"./form_delete_missions.php\" >" . $row_air['mis_id'] . " </a> </td>";                                                     
                                                    } else {                                                        
                                                        echo "<td class=\"mis_id\"> <a class=\"btn btn-outline btn-primary\" >" . $row_air['mis_id'] . "  </a> </td>";
                                                        //echo "<td class=\"mis_id\"> <a class=\"btn btn-outline btn-primary\" href=\"./form_delete_missions.php\" >" . $row_air['mis_id'] . " </a> </td>"; 
                                                    }       
                        ...
                        <!-- /.row -->
                                        ...
                                        <div class="panel-heading text-right">
                                            ...
                                            if ($user->role == "SYS" || $user->role == "OPS" || $user->role2 == "OPS+") {
                                                echo "<strong class=\"add_mission\" style=\"background-color: yellow;\"> <a href=\"./form_add_missions.php\">" . " Add new Mission "  .  " </a> </strong>";
                                            } else {
                                                echo "<strong class=\"add_mission\" style=\"background-color: yellow;\"> <a href=\"#\">" . " Add new Mission "  .  " </a> </strong>";    
                                            }                                                                                                                                  
                                            ?>
                                        ...
                                        <div class="panel-heading text-right">
                                            ...
                                            if ($user->role == "SYS" || $user->role == "OPS" || $user->role2 == "OPS+") {
                                                echo "<strong class=\"del_missions\" style=\"background-color: red;\"> <a href=\"./form_delete_missions.php\">" . " Delete Missions "  .  " </a> </strong>";
                                            } else {
        ...
        <script src="../js/form_view_missions.js"></script>
