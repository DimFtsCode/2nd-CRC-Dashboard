...
<html lang="en">   
    ...
    <head>
        ...
        <title> Form View Personnel Files</title> 
        <!-- Bootstrap Core CSS -->
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" >
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; ">  View Personnel Files  </strong> </a>
           ...
           <div class="panel-heading text-center">
                        <div class="col-lg-12">
                            <h1 class="page-header" style="color: red;"> Προβολή Φακέλων Προσωπικού --- <?php echo date("j - m - Y"); ?></h1>
                        </div>
                        <!-- /.col-lg-12 -->
             </div>     
            ...
            <div class="panel-body">
                <div cla    ss="dataTables_wrapper">
                    ...
                    require_once("../php_functions/functions.inc");
                    $class = "table";
                    $headArray = array("SN", "ΑΣΜΑ", "Βαθμός", "Ειδ.", "Επιθετο", "Ονομα", "Διεύθυνση", "ΙΑΤΡΙΚΟΣ", "ΘΕΣΗ", "ΕΚΠ", "ΘΕΣΗ", "ΑΒM", "ΘΕΣΗ");
                    ...
                    $sql = "SELECT medata.*, personnel.*, divisions.description AS My_DIV, ranks.* FROM medata, personnel, divisions, ranks WHERE personnel.division = divisions.id  AND personnel.asma=medata.asma AND ranks.rank=personnel.rank  AND personnel.unit ='{$myUnit}'  ORDER BY ranks.priority ASC, personnel.asma ASC";
                    ...
                    while ($row_personnel = mysqli_fetch_array($res)) {
                        ...
                        echo "<td>" . $row_personnel['medfolder_yn'] . "</td>";
                        echo "<td>" . $row_personnel['medfolder_loc'] . "</td>";
                        echo "<td>" . $row_personnel['trfolder_yn'] . "</td>";
                        echo "<td>" . $row_personnel['trfolder_loc'] . "</td>";
                        echo "<td>" . $row_personnel['abm_yn'] . "</td>";
                        echo "<td>" . $row_personnel['abm_loc'] . "</td>";
                        echo "</tr>";
                        $serial = $serial + 1;
                    }
