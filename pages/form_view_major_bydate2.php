    ...
    <body>
        ...
        <div id="wrapper">
           ...
           <div class="panel-heading text-center">
            ...
            <div class="panel-heading text-center">
                        <div class="col-lg-12">                            
                             <h3 class="page-header" style="color: red;"> Προβολή Σημαντικών Συμβάντων συγκεκριμένης Περιόδου --- από : <?php echo $myDate; ?>  --- έως : <?php echo $myDate2; ?></h3>
                        </div>                        
            </div>   
            ...
            <div class="panel-body">
                <div class="dataTables_wrapper">
                    ...
                    $sql = "SELECT major.* FROM major WHERE (DATE(major.date_start) BETWEEN '{$myDate}' AND '{$myDate2}') ORDER BY date_start DESC";
        ...
        <script type="text/javascript" src="../js/form_view_major_bydate2.js"></script>  
