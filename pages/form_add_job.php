...
<html lang="en">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Ενημέρωση Κύριας Εργασίας </h1>
                        </div>
                    ...
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_add_school_asma" class="form-horizontal" action="../php_functions/job_insert.php" method="POST">
                            <div id="errorDiv"> 
                                <?php
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <textarea  id="description" name="description" class="form-control" rows="5" style="width: 900px;" placeholder="description" ></textarea>
                                </div>
                            </div>
        ...
        <script type="text/javascript" src="../js/add_job.js"></script>
