                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <div class="dataTables_wrapper">
                                                ...
                                                $class = "table";
                                                $headArray = array("SN", "ID", "AIRPORT", "NUM", "TYPE", "CALLSIGN", "STATUS",  "PERIOD", "REMARKS", "DATE_REG", "by_USER", "DEL");
                                        ...
                                        <div class="panel-heading text-right">
                                            <?php
                                            if ($user->role == "SYS" || $user->role2 == "OPS+") {
                                                echo "<strong class=\"add_resc\" style=\"background-color: yellow;\"> <a href=\"./form_add_resc_asset.php\">" . " Add new Rescue Asset " . " </a> </strong>";
                                            } else {
                                                echo "<strong class=\"add_resc\" style=\"background-color: yellow;\"> <a href=\"#\">" . " Add new Rescue Asset " . " </a> </strong>";
                                            }
                                            ?>
