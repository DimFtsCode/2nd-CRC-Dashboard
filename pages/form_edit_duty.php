...
<html lang="en">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; "> Edit Duties </strong> </a>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Διόρθωση Καθηκόντων Προσωπικού</h1>
                        </div>
                    ...
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_edit_duty" class="form-horizontal" action="../php_functions/duty_edit.php" method="POST">
                            <div id="errorDiv"> 
                                <?php
                                ...
                                <label class="col-sm-2 control-label">ΑΣΜΑ : </label>
                                 <div class="col-sm-4">
                                     <div class="input-group mb-3">
                                         <input  type="text" id="asma" name="asma" class="form-control" placeholder="asma" required="asma" readonly>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" id="division" name="division" class="form-control" placeholder="division" required="division" style="display:none" readonly value="<?php $myVarDIV = $user->asma;  $myVarDIV = $myVarDIV . "DIV";echo $_SESSION[$myVarDIV]?>" >
                            ...
                            <div class="form-group">
                                ...
                                <div  class="input-group date col-sm-2" >
                                    <input type="text" id="date1" name="date1" class="form-control date datepicker" required="date1" >
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                </div>
                            </div>   
                            
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Duty1 : </label>
                                <div class="col-sm-4">
                                    <select class="form-control"  id="duty1"  name="duty1" required="duty1" >
                                        <option value="" selected disabled>  duty1 </option>
                                        <?php
                                        ...
                                        $MyDivision = $_SESSION[$myVarDIV];
                                        $MyDivND = "1001";
                                        $sql = "SELECT  duties.* FROM duties WHERE duties.divid ='{$MyDivision}' ORDER BY pri ";
                                        $sql1 = "SELECT  duties.* FROM duties WHERE duties.divid ='{$MyDivND}' ORDER BY pri ";
                                        $div = $db->runQuery($sql);
                                        while ($row_div = mysqli_fetch_array($div)) {
                                            echo "<option value=\"" . $row_div['description'] . "\">" . $row_div['description'] . "</option>";
                                        }
                                        //echo "<option value=\"NO DUTY\">WITH OUT DUTY</option>";
                                        $div1 = $db->runQuery($sql1);
                                        while ($row_div1 = mysqli_fetch_array($div1)) {
                                            echo "<option value=\"" . $row_div1['description'] . "\">" . $row_div1['description'] . "</option>";
                                        }
                                        ?>                                        
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div  class="input-group date col-sm-2" >
                                    <input type="text" id="date2" name="date2" class="form-control date datepicker"  >
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                </div>
                            </div>   
                            
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Duty2 : </label>
                                <div class="col-sm-4">
                                    <select class="form-control"  id="duty2"  name="duty2"  >
                                        <option value="" selected disabled>  duty2 </option>
                                        <?php                                                                               
                                        require_once '../php_functions/db_config/db_connect.php';
                                        $db = new DbMgmt;
                                        $sql = "SELECT  duties.* FROM duties ORDER BY divid ASC, pri ASC";
                                       // $sql = "SELECT  * FROM `duties` ORDER BY `pri` ";
                                        $div = $db->runQuery($sql);
                                        while ($row_div = mysqli_fetch_array($div)) {
                                            echo "<option value=\"" . $row_div['description'] . "\">" . $row_div['description'] . "</option>";
                                        }
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"> Date3 : </label>
                                <div  class="input-group date col-sm-2" >
                                    <input type="text" id="date3" name="date3" class="form-control date datepicker"  >
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                </div>
                            </div>   
                            
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Duty3 : </label>
                                <div class="col-sm-4">
                                    <select class="form-control"  id="duty3"  name="duty3"  >
                                        <option value="" selected disabled>  duty3 </option>
                                        <?php                                                                               
                                        require_once '../php_functions/db_config/db_connect.php';
                                        $db = new DbMgmt;
                                        $sql = "SELECT  duties.* FROM duties ORDER BY divid ASC, pri ASC";
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" style="display:none" >Division : </label>
                                <div class="col-sm-4">
                                    <input type="text" id="division" name="division" class="form-control" placeholder="division" required="division" style="display:none" readonly >
        ...
        <script type="text/javascript" src="../js/edit_duty.js"></script>
