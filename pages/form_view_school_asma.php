        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" >
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="./form_select_school.php"> <strong style="color: darkred; ">  Personnel by School </strong> </a>  
                ...
                <div class="dataTables_wrapper">
                    ...
                    while ($row = mysqli_fetch_array($res)) {
                        ...
                        if ($user->role == "SYS" || $user->role2 == "TRAIN+" || $user->role3 == "TRAIN") {
                            echo "<td class=\"shid\" > <a href=\"form_edit_training.php\" >" . "<strong style=\"color: blue; font-size: 16px;\">" . $row['trnid'] . "</strong>". " </a> </td>";
                           // echo "<td class=\"shid\" > <a href=\"form_edit_training.php\" >" . "<strong style=\"color: blue; font-size: 16px;\">" . $row['shid'] . "</strong>". " </a> </td>";
                        } else {
                            echo "<td class=\"shid\" > <a href=\"\" >" . "<strong style=\"color: blue; font-size: 16px;\">" . $row['trnid'] . "</strong>". " </a> </td>";
                        }
                        ...
                        if ($user->role == "SYS" || $user->role2 == "TRAIN+" || $user->role3 == "TRAIN") {
                            echo "<td class=\"trnid\" > <a href=\"form_delete_training.php\" >" . "<strong style=\"color: blue; font-size: 16px;\">" . $row['trnid'] . "</strong>". " </a> </td>";
                        } else {
