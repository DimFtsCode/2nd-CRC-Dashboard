...
<html lang="en">
    ...
    <body>
        <div id="container">
            <div id="header">
                <h1> 2o AKE / Μοίρα Επιχειρήσεων -- Προβολή Status Ασυρμάτων </h1>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="panel panel-default">
                                        <div class="panel-heading text-center">
                                            ...
                                            <strong> ------ </strong>
                                             <strong><a href="./form_view_tdl_public.php">Next</a></strong>
                                        </div>
                                        <!--                                    <div class="panel-heading text-center">
                                        ...
                                        <div class="panel-body">
                                            <div class="dataTables_wrapper">
                                                ...
                                                //$sql = "SELECT * FROM `radio` ORDER BY `radio`.`radio_id` ASC";
                                        ...
                                        <div class="panel-heading text-right">
                                            <?php                                           
                                                echo "<strong class=\"stat_nato\" style=\"background-color: yellow;\"> <a href=\"./form_view_tdl_public.php\">" . " Next "  .  " </a> </strong>";                                                                                                                               
                                            ?>
