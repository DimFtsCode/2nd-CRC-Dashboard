...
<html lang="en">
    ...
    <head>
        ...
        <title> Form Delete TPYE to Personnel </title>
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; "> Delete TPYE Personnel </strong> </a>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Διαγραφή Τακτικής Περιοδικής Υγ. Εξέτασης (ΤΠΥΕ) από Προσωπικό </h1>
                        </div>
                    ...
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_delete_tpye_asma" class="form-horizontal" action="../php_functions/tpye_delete.php" method="POST">
                            <div id="errorDiv"> 
                                <?php
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" id="hospital" name="hospital" class="form-control" placeholder="hospital" readonly>                                    
                                </div>
                            </div> 
        ...
        <script type="text/javascript" src="../js/delete_tpye_asma.js"></script>
