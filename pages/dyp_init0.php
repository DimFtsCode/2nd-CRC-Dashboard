...
<html>
    <head>        
        ...
        echo("<link rel=\"stylesheet\" type=\"text/css\"  href=\"../styles/style_dyp0.css?v=" .rand() . "\">" );        
        ?>
    ...
    <body>
        <div id="container">
            <div id="header">
                <h1> 2o AKE / ΔΙΕΥΘΥΝΣΗ ΥΠΟΣΤΗΡΙΞΗΣ  </h1>
            </div> <!-- end header -->
            <div id="menu">
                <ul>
            ...
            <div id="mainContainer">
                ...
                <div id="content">
                    <h2> <span style="text-align: center; text-decoration: underline; color: red;"> ΔΙΕΥΘΥΝΣΗ ΥΠΟΣΤΗΡΙΞΗΣ  </span> </h2>
                    
                    <p style="color: blue; width: 90%; font-size: large"> Η Διεύθυνση Υποστήριξης στο 2ο ΑΚΕ έχει ως κύριο έργο ......  </p> 
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="custom"> <a href="../web/dyp/useful"> <span style="color: black; background-color: yellow; "> Διάφορα / Χρήσιμα </span></a> </td> 
                            <td class="sideR"> <a href="../web/dyp/prs"> <span style="color: black; background-color: yellow; "> #~ Ενημέρωση Προσωπικού </span></a> </td>
                        </tr>
                        <tr>
                            <td class="code"> <a href=""> <span style="color: black; background-color: yellow; "> ... TBD </span></a> </td>                             
                        ...
                        <tr>
                            <td class="code"> <a href="../web/dyp/entypa"> <span style="color: black; background-color: cyan; "> ΠΡΟΤΥΠΑ ΕΝΤΥΠΑ </span></a> </td>
                        ...
                        <tr>
                            <td class="code"> <a href="../web/dyp/diagrams"> <span style="color: black; background-color: yellow; "> Τοπογραφικά Σχέδια </span></a> </td>
                        ...
                        <tr>
                            <td class="custom"> <a href="../web/dyp/checklists"> <span style="color: black; background-color: yellow; "> Εγχειρίδια - CheckLists </span></a> </td>  
