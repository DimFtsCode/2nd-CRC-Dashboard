...
<html lang="en">   
    ...
    <head>
        ...
        <title> Form View Event by Date </title> 
        <!-- Bootstrap Core CSS -->
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" >
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red;">  View Events by Date </strong> </a>
           ...
           <div class="panel-heading text-center">
                        <div class="col-lg-12">                            
                             <h1 class="page-header" style="color: blue;"> Προβολή Μεταβολών Προσωπικού που έχει μετατεθεί  --- <?php echo date("j - m - Y"); ?> </h1>
                        </div>                        
            </div>     
            
            <div class="panel-heading text-center">
                        <div class="col-lg-12">                            
                             <h3 class="page-header" style="color: red;"> Προβολή Μεταβολών συγκεκριμένης Περιόδου που έχει μετατεθεί  --- από : <?php echo $myDate; ?>  --- έως : <?php echo $myDate2; ?></h3>
                        </div>                        
            </div>   
            ...
            <div class="panel-body">
                <div class="dataTables_wrapper">
                    ...
                    $class = "table";
                    $myUnit = "OTHER";
                    $headArray = array("SN", "ID", "EDIT", "ΕΙΔ", "ΕΠΙΘΕΤΟ", "ΟΝΟΜΑ", "ΕΝΑΡΞΗ", "ΠΕΡΑΣ", "ΚΑΤΗΓΟΡΙΑ", "ΠΕΡΙΓΡΑΦΗ", "ΘΕΣΜ. ΚΕΙΜΕΝΟ", "Reg_User", "DEL" );
                    $head = count($headArray);   
                    
                    $sql = "SELECT event.*, event.user_reg as MyUserReg, personnel.* FROM event, personnel WHERE personnel.asma = event.asma AND personnel.unit ='{$myUnit}' AND (DATE(event.date_start) BETWEEN '{$myDate}' AND '{$myDate2}') ORDER BY date_start DESC";
