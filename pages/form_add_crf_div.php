...
<html lang="en">
    ...
    <head>
        ...
        <title> Form Add CRF to Division </title>
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; "> Add CRF Files to Division </strong> </a>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Προσθήκη CRF Αρχείου σε Διεύθυνση / Μοίρα / Επιστασία </h1>
                        </div>
                    ...
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_add_crf_div" class="form-horizontal" action="../php_functions/add_crf_div.php" method="POST" >
                        <!--<form id="form_add_crf_div" name="form_add_crf_div" class="form-horizontal" onsubmit="return onsubmitform();" method="POST">-->    
        ...
        <script type="text/javascript" src="../js/add_crf_div.js"></script>
...
<!--        <script type="text/javascript">
        function OnSubmitForm()
        {
          ...
          {
           document.form_add_crf_div.action ="../php_functions/add_crf_div.php";
          }
          else
          if(document.pressed == 'Update')
          {
            document.form_add_crf_div.action ="../php_functions/delete_crf_div.php";
          }
          return true;
        }
        </script>-->
