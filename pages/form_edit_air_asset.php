...
<html lang="en"> 
    ...
    <head>
        ...
        <title> Form Edit Air Asset </title> 
        <!-- Bootstrap Core CSS -->
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; "> Edit  Air Asset  </strong> </a>
                </div>
...
<!--                                <a href="admin_dashboard.php"><i class="fa fa-dashboard fa-fw"></i> Admin Dashboard</a>-->
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Επεξεργασία Στοιχείων  Ετοιμότητας Α/Φ</h1>                             
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_edit_air_asset" class="form-horizontal" action="../php_functions/air_asset_edit.php" method="POST">                            
...
<!--                                <button type="button" id="btn_delete" name ="btn_delete" style="background-color: yellow" style="font-size: larger"> Delete Record </button>-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select class="form-control"  id="air_id" name="air_id" required="air_id" readonly >
                                        <option value="" selected disabled> air_id </option>
                                        <?php
                                        ...
                                        while ($row_air = mysqli_fetch_array($air_id)) {
                                            echo "<option value=\"" . $row_air['air_id'] . "\">" . $row_air['air_id'] . " -- ". $row_air['base'] . " -- ". $row_air['scope'] ."</option>";
                                        }
                                        ?>                                        
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-4">
                                    <button type="submit" class="btn btn-default" id="submit" name="submit"> Update Air Asset</button>
                                </div>
                            </div>
        ...
        <script type="text/javascript" src="../js/edit_air_asset.js"></script> 
