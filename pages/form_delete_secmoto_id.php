...
<html lang="en">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; "> Delete Personnel Moto Data</strong> </a>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Διαγραφή Στοιχείων Ασφαλείας Οχημάτων </h1>
                        </div>
                    ...
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_edit_event" class="form-horizontal" action="../php_functions/secmoto_delete.php" method="POST">
                            <div id="errorDiv"> 
                                <?php
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" id="cardno" name="cardno" class="form-control" placeholder="card number" readonly>                                    
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div  class="input-group date col-sm-2" >
                                    <input type="text" id="expmoto" name="expmoto" class="form-control date datepicker" readonly >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">                                    
                                    <select class="form-control" id="typec" name="typec" readonly >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" id="plates" name="plates" class="form-control" placeholder="plates" readonly>                                    
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" id="brand" name="brand" class="form-control" placeholder="brand" readonly>                                    
                                </div>
                            </div> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" id="colour" name="colour" class="form-control" placeholder="colour" readonly>                                    
                                </div>
                            </div>   
        ...
        <script type="text/javascript" src="../js/delete_secmoto_id.js"></script>
