        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Διόρθωση Σχολείου / Σεμιναρίου </h1>
                        </div>
...
<!--                           <input type="text" id="my_asma" name="my_asma" class="form-control"  style="display:none" value="<?php echo $user->asma; ?>"  readonly >-->
                    ...
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_edit_school" class="form-horizontal" action="../php_functions/school_edit.php" method="POST">
                            <div id="errorDiv"> 
                                <?php
                                ...
                                <label class="col-sm-2 control-label">School ID : </label>
                                 <div class="col-sm-4">
                                     <div class="input-group mb-3">
                                         <input  type="text" id="shid" name="shid" class="form-control" placeholder="shid" readonly >
                                                                       
                                    </div>
                                </div>
                            </div> 
                            <div> <span class="errorFeedback errorSpan" id="shidError">Shcool ID should be only numbers</span></div>                                                                                                                   
                         ...
                         <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label "  style="display:none" >ΟΝΟΜΑ_old : </label>
                                <div class="col-sm-2">
                                    <input type="text" id="shname_old" name="shname_old" class="form-control" placeholder="shname_old" style="display:none" readonly="">                                    
                                </div>
                            </div>
        ...
        <script type="text/javascript" src="../js/edit_school.js"></script>
