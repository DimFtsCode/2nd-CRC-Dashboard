...
<html lang="en">
    ...
    <head>
        ...
        <title> Form View / Edit Sensor </title> 
        <!-- Bootstrap Core CSS -->
...
<!--                            <div class="col-lg-12">
                                        ...
                                        <div class="panel-body">
                                            <div class="dataTables_wrapper">
                                                ...
                                                while ($row_radar = mysqli_fetch_array($res)) {
                                                    ...
                                                    if ($user->role == "SYS" || $user->role == "ADP" || $user->role == "OPR") {
        ...
        while ($row_update_sensor = mysqli_fetch_array($qry_update_sensor)) {
            ...
            echo "<input type=\"text\" id=\"tbc\"  name=\"tbc\" class=\"form-control date datepicker\" required=\"date\" value=\" " .$date_update ."\"> ";
