...
<html lang="en">
    ...
    <head>
        ...
        <title> Form Insert New SART </title>  
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; "> Insert New SART  </strong> </a>
                </div>
            ...
            <div id="page-wrapper">
                <div class="container-fluid"> 
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Εισαγωγή Νέας Εγγραφής Κατάστασης Α/Δ </h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_add_sart" class="form-horizontal" action="../php_functions/sart_insert.php" method="POST">   
        ...
        <script type="text/javascript" src="../js/add_sart.js"></script>
