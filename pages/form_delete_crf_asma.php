...
<html lang="en">
    ...
    <head>
        ...
        <title> Form Delete CRF from User </title>
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; "> Delete CRF File from User </strong> </a>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Διαγραφή CRF Αρχείου από  Χρήστη </h1>
                        </div>
                    ...
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_delete_crf_asma" class="form-horizontal" action="../php_functions/delete_crf_asma.php" method="POST" >                          
        ...
        <script type="text/javascript" src="../js/delete_crf_asma.js"></script>
