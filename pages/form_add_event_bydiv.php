...
<html lang="en">   
    ...
    <head>
        ...
        <title> Form Add Event by Division</title> 
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" >
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red;"> Add Event by Division </strong> </a>
           ...
           <div class="panel-heading text-center">
                        <div class="col-lg-12">                            
                             <h1 class="page-header" style="color: red;"> Εισαγωγή Μεταβολών σε ΠΡΣ / Επιστασία --- <?php  echo  "<strong style=\"color: black; font-size: 40px; background-color: yellow;\">" .  $myDivision . "</strong>"; ?>  ---- <?php echo date("j - m - Y"); ?> </h1>
                        </div>                        
             </div>     
                ...
                <div class="dataTables_wrapper">
                    ...
                    while ($row_personnel = mysqli_fetch_array($res)) {
                        ...
                        echo "<td class=\"serial\">" . $serial . "</td>";
                         ...
                         echo "<td class=\"asma\" > <a href=\"./form_add_event_asma.php\" >" . "<strong style=\"color: blue; font-size: 16px;\">" . $row_personnel['asma'] . "</strong>". " </a> </td>";
        ...
        <script type="text/javascript" src="../js/form_add_event_bydiv.js"></script>  
