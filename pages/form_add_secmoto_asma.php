...
<html lang="en">
    ...
    <head>
        ...
        <title> Form Add Secdata Moto </title>
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; "> Add Moto Secdata</strong> </a>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Εισαγωγή Στοιχείων Ασφαλείας Οχημάτων </h1>
                        </div>
                    ...
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_add_school_asma" class="form-horizontal" action="../php_functions/secmoto_insert.php" method="POST">
                            <div id="errorDiv"> 
                                <?php
        ...
        <script type="text/javascript" src="../js/add_secmoto_asma.js"></script>
