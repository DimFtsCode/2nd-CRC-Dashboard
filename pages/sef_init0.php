...
<html>
    <head>        
        ...
        echo("<link rel=\"stylesheet\" type=\"text/css\"  href=\"../styles/style_sef0.css?v=" .rand() . "\">" );        
        ?>
    ...
    <body>
        <div id="container">
            <div id="header">
                <h1> 2o AKE / ΣΜΗΝΟΣ ΕΦΟΔΙΑΣΜΟΥ  </h1>
            </div> <!-- end header -->
            <div id="menu">
                <ul>
            ...
            <div id="mainContainer">
                ...
                <div id="content">
                    <h2> <span style="text-align: center; text-decoration: underline; color: red;"> ΣΜΗΝΟΣ ΕΦΟΔΙΑΣΜΟΥ  </span> </h2>
                    
                    <p style="color: blue; width: 90%; font-size: large"> Το Σμήνος Εφοδιασμού στο 2ο ΑΚΕ έχει ως κύριο έργο ......  </p> 
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="custom"> <a href="../web/sef/useful"> <span style="color: black; background-color: yellow; "> Διάφορα / Χρήσιμα </span></a> </td> 
