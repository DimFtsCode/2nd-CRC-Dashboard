    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div class="panel-heading text-center">
                        <div class="col-lg-12">
                            <h1 class="page-header" style="color: red;">2οΑΚΕ // Προβολή ΤΠΥΕ Συνόλου Προσωπικού --- <?php echo date("j - m - Y"); ?></h1>
                        </div>
                        <!-- /.col-lg-12 -->
             </div> 
            ...
            <div class="panel-body">
                <div class="dataTables_wrapper">
                    ...
                    $sql = "SELECT personnel.*, divisions.description AS My_DIV, ranks.*, tpye.* FROM personnel, divisions, ranks, tpye WHERE personnel.asma=tpye.asma AND personnel.division = divisions.id AND ranks.rank=personnel.rank  AND personnel.unit ='{$myUnit}' AND tpye.date_end !='{$Mydate}' AND (tpye.exam_type='{$myExam1}' OR tpye.exam_type='{$myExam2}' OR tpye.exam_type='{$myExam3}' OR tpye.exam_type='{$myExam4}' OR tpye.exam_type='{$myExam5}') ORDER BY ranks.priority ASC, personnel.asma ASC, tpye.date_end DESC ";                  
