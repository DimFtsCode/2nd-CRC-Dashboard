...
<html lang="en">
    ...
    <head>
        ...
        <title> Form Edit Personnel </title>
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; "> Edit Personnel   </strong> </a>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Επεξεργασία Στοιχείων Προσωπικού</h1>
                        </div>
                    ...
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_edit_personnel" class="form-horizontal" action="../php_functions/personnel_edit.php" method="POST">
                            <div id="errorDiv"> 
                                <?php
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control" id="branch" name="branch" required="branch">
        ...
        <script type="text/javascript" src="../js/edit_personnel2.js"></script>
