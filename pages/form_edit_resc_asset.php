...
<html lang="en">
    ...
    <head>
        ...
        <title> Form Edit RESC Asset </title> 
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; "> Edit RESC Asset   </strong> </a>
                </div>
            ...
            <div id="page-wrapper">
                <div class="container-fluid"> 
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Επεξεργασία Εγγραφής Ετοιμότητας Α/N Μέσων </h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_edit_resc_asset" class="form-horizontal" action="../php_functions/resc_asset_edit.php" method="POST">   
        ...
        <script type="text/javascript" src="../js/edit_resc_asset.js"></script>
