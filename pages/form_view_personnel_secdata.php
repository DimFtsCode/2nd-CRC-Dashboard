...
<html lang="en">   
    ...
    <head>
        ...
        <title> Form View Personnel Secdata</title> 
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" >
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; ">  View Personnel SecData </strong> </a>
                    <a class="navbar-brand" href="dashboard.php"> <strong style="color: blue; ">  Dashboard   </strong> </a>   
                    <a class="navbar-brand" href="./form_view_personnel_secmoto.php"> <strong style="color: darkred; ">  Προβολή Στοιχείων Ασφαλείας Οχημάτων </strong> </a>  
            ...
            <div class="panel-heading text-center">
                        <div class="col-lg-12">
                            <h1 class="page-header" style="color: red;"> Προβολή Στοιχείων Ασφαλείας Προσωπικού --- <?php echo date("j - m - Y"); ?></h1>
                        </div>
                        <!-- /.col-lg-12 -->
             </div> 
            ...
            <div class="panel-body">
                <div class="dataTables_wrapper">
                    ...
                    $class = "table";
                    $headArray = array("SN", "ΑΣΜΑ", "ID", "Βαθμός", "Ειδ.", "Επιθετο", "Ονομα", "Επιστασία", "ΑΡΙΘ. ΚΑΡΤΑΣ", "ΗΜΕΡ. ΛΗΞΗΣ", "ΚΑΡΤΑ OPS", "ΔΙΑΒΑΘΜΙΣΗ", "ΠΡΟΣΒΑΣΗ", "SEC. CLEARANCE", "EXP. DATE");
                    ...
                    $sql = "SELECT personnel.*, divisions.description AS My_DIV, ranks.*, security.* FROM personnel, divisions, ranks, security WHERE personnel.asma=security.asma AND personnel.division = divisions.id AND ranks.rank=personnel.rank  AND personnel.unit ='{$myUnit}'  ORDER BY ranks.priority ASC, personnel.asma ASC"; 
                    ...
                    while ($row_personnel = mysqli_fetch_array($res)) {
                        ...
                        echo "<td class=\"secid\" > <a href=\"./form_edit_secdata_asma.php\" >" . "<strong style=\"color: blue; font-size: 16px;\">" . $row_personnel['secid'] . "</strong>". " </a> </td>";
                        ...
                        //echo "<td>" . $row_personnel['expdate'] . "</td>";
                        echo "<td class=\"expdate\">" .$row_personnel['expdate'] . "</td>";
                        echo "<td>" . $row_personnel['eid'] . "</td>";
                        echo "<td>" . $row_personnel['seclevel'] . "</td>";
                        echo "<td>" . $row_personnel['access'] . "</td>";
                        echo "<td>" . $row_personnel['clearance'] . "</td>";
                         echo "<td>" . $row_personnel['expclear'] . "</td>";
        ...
        <script type="text/javascript" src="../js/form_view_personnel_secdata.js"></script>
