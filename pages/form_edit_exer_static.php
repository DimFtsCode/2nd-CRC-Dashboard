...
if (!($user->role == "SYS" || $user->role == "EXER" || $user->role2 == "EXER+" || $user->role2 == "OPS+")) {
...
<html lang="en"> 
    ...
    <head>
        ...
        <title> Form Edit Exercise Static Data </title> 
        <!-- Bootstrap Core CSS -->
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; "> Edit Exercise Static Data  </strong> </a>
                </div>
...
<!--                                <a href="admin_dashboard.php"><i class="fa fa-dashboard fa-fw"></i> Admin Dashboard</a>-->
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Επεξεργασία Επιπλέον Στοιχείων Άσκησης - Αξιολόγησης </h1>                             
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_edit_exer_static" class="form-horizontal" action="../php_functions/exer_static_edit.php" method="POST">                            

                            <div class="form-group">
                                <legend class="col-sm-2 control-label">  Exercise Static Data  </legend>
...
<!--                                <span id="delete_btn" style="background-color: yellow"> You must select an Air Asset prior to EDIT it ! </span>                                                            -->
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"> Exercise Info : </label>
                                <div class="col-sm-4">
                                    <?php
                                        require_once '../php_functions/db_config/db_connect.php';
                                        $db = new DbMgmt;
                                        $sql = "SELECT * FROM exerstatic WHERE exer_id=1 ";
                                        $qry = $db->runQuery($sql);
                                         $row_res = mysqli_fetch_array($qry); 
                                            $ex_remark =  $row_res['ex_remark'];                                              
                                            echo  "<textarea id=\"exer_info\" name=\"exer_info\" class=\"form-control\" rows=\"2\" required=\"exer_info\" >$ex_remark</textarea>";
                                            echo "<span class=\"errorFeedback errorSpan\" id=\"exer_infoError\">EXERCISE INFO  should be only capital letters </span>";
...
<!--                                    <span class="errorFeedback errorSpan" id="gr_ramrodError">GR RAMROD  should be only capital letters </span>-->
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-4">
                                    <button type="submit" class="btn btn-default" id="submit" name="submit"> Update Exer Static Data</button>
                                </div>
                            </div>
