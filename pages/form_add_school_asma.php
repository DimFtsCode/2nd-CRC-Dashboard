...
<html lang="en">
    ...
    <head>
        ...
        <title> Form Add School to Personnel </title>
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; "> Add School to Personnel </strong> </a>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Εισαγωγή Σχολείων σε Προσωπικό </h1>
                        </div>
                    ...
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_add_school_asma" class="form-horizontal" action="../php_functions/training_insert.php" method="POST">
                            <div id="errorDiv"> 
                                <?php
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select class="form-control"  id="shid"  name="shid" required>
                                        <option value="" selected disabled> School </option>
                                        <?php
                                        require_once '../php_functions/db_config/db_connect.php';
                                        $db = new DbMgmt;
                                        $sql = "SELECT * FROM schools ORDER by shname ASC";
                                        // $sql = "SELECT `rank`, `priority` FROM `ranks` ORDER BY `priority` ";
                                        $shid = $db->runQuery($sql);
                                        while ($row = mysqli_fetch_array($shid)) {
                                            echo "<option value=\"" . $row['shid'] . "\">" . $row['shname'] . " -- " . $row['shtype'] . " -- " . $row['shid'] . "</option>";
                                        }
                                        ?>                                        
                                    </select>
                                </div>
        ...
        <script type="text/javascript" src="../js/add_school_asma.js"></script>
