...
<html lang="en">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; "> Add Duties </strong> </a>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Εισαγωγή Καθηκόντων Προσωπικού</h1>
                        </div>
                    ...
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_add_duty" class="form-horizontal" action="../php_functions/duty_insert.php" method="POST">
                            <div id="errorDiv"> 
                                <?php
        ...
        <script type="text/javascript" src="../js/add_duty.js"></script>
