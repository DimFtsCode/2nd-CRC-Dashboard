...
<html lang="en">   
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" >
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="./form_view_supply_kae.php"> <strong style="background-color: cyan; color: darkred; "> Προβολή ανά ΚΑΕ </strong> </a>
                    ...
                    <a class="navbar-brand" href="./form_view_supply_kae_own.php"> <strong style="background-color: yellow; color: darkred; ">Προβολή ανά ΚΑΕ & ΧΡΗΜΑΤΟΔΟΤΗΣΗ</strong> </a>
           ...
           <div class="panel-heading text-center">
                        <div class="col-lg-12">                            
                             <h1 class="page-header" style="color: blue;"> Προβολή Εντολών Αγοράς / Εργασίας Έτους  --- <?php echo $DefYear; ?> </h1>
                        </div>                        
           </div>                    
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                                <label class="col-sm-2 control-label"> ΕΠΙΛΕΞΤΕ ΕΤΟΣ ΕΝΤΟΛΗΣ : </label>
                                <div class="col-sm-2">                                    
                                    <select class="form-control" id="year" name="year" required="year">
                                      <option value="<?php echo $DefYear; ?>" selected > <?php echo$DefYear; ?> </option>  
                                      <?php
            ...
            <div class="panel-body">
                <div class="dataTables_wrapper">
                    ...
                    //$headArray = array("SN", "ID", "Αρ.ΕΝ", "ΗΜΕΡ. ΕΝΤ.", "ΠΕΡΙΓΡΑΦΗ", "ΧΕΙΡΙΣΤΗΣ", "ΕΚΤ. ΚΟΣΤΟΣ", "ΠΕΡΙΓΡ. ΚΑΕ/ΑΛΕ", "test");
                    $headArray = array("SN", "ID", "Αρ.ΕΝ", "ΗΜΕΡ. ΕΝΤ.", "ΠΕΡΙΓΡΑΦΗ", "ΔΝΣΗ", "ΤΜΗΜΑ", "ΧΕΙΡΙΣΤΗΣ", "ΕΚΤ. ΚΟΣΤΟΣ", "ΠΕΡΙΓΡ. ΚΑΕ/ΑΛΕ", "CODE", "ΕΙΔΟΣ ΕΝΤ.", "ΥΠΗΡ.ΣΗΜ.", "Link ΥΣ", "ΧΡΗΜΑΤ.", "ΠΑΡΑΛΗΦΘΗ", "ΠΑΡΑΓΓΕΛ.", "ΠΡΟΜΗΘΕΥΤΗΣ", "ΤΙΜΟΛΟΓΙΟ", "ΤΕΛ. ΚΟΣΤ", "STATUS", "ΠΑΡΑΤΗΡ.", "DETAIL" );
                    //$headArray = array("SN", "ID", "Αρ.ΕΝ", "ΗΜΕΡ. ΕΝΤ.", "ΠΕΡΙΓΡΑΦΗ", "ΔΝΣΗ", "ΤΜΗΜΑ", "ΧΕΙΡΙΣΤΗΣ", "ΕΚΤ. ΚΟΣΤΟΣ", "ΠΕΡΙΓΡ. ΚΑΕ/ΑΛΕ" );
				...
				$myBranch = $row_branch['branch'];
                        ...
                        $myRemark = $row['own_budget'] . " //-- ". $row['remark'];
                       ...
                       echo "<td class=\"budget\">" . $myBudget . "</td>";                                                                        
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <div class="dataTables_wrapper">
                                                ...
                                                $class2 = "table";
                                                $headArray2 = array("SN", "ID", "Αρ.ΕΝ", "ΗΜΕΡ. ΕΝΤ.", "ΠΕΡΙΓΡΑΦΗ", "ΔΝΣΗ", "ΤΜΗΜΑ", "ΧΕΙΡΙΣΤΗΣ", "ΕΚΤ. ΚΟΣΤΟΣ", "ΠΕΡΙΓΡ. ΚΑΕ/ΑΛΕ", "CODE", "ΕΙΔΟΣ ΕΝΤ.", "ΥΠΗΡ.ΣΗΜ.", "Link ΥΣ", "ΧΡΗΜΑΤ.", "ΠΑΡΑΛΗΦΘΗ", "ΠΑΡΑΓΓΕΛ.", "ΠΡΟΜΗΘΕΥΤΗΣ", "ΤΙΜΟΛΟΓΙΟ", "ΤΕΛ. ΚΟΣΤ", "STATUS", "ΠΑΡΑΤΗΡ.", "DETAIL" );
       ...
       <!-- /#wrapper -->
        ...
        <script type="text/javascript" src="../js/form_view_supply_main.js"></script>  
