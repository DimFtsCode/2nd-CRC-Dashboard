...
<html lang="en">   
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" >
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="./form_view_intercept_bydiv.php"> <strong style="color: darkred; ">  Προβολή Αναχαιτίσεων ΠΡΣ </strong> </a>  
           ...
           <div class="panel-heading text-center">
            ...
            <div class="panel-heading text-center">                                          
                <strong style="color: black; background-color: yellow; font-size: 18px;"> ΠΡΟΒΟΛΗ  ΑΝΑΧΑΙΤΙΣΕΩΝ  του / της :  </strong> 
            ...
            <div class="panel-body">
                <div class="dataTables_wrapper">
                    ...
                    $class = "table";
                    //$myDate = "2022-12-20";
                    $headArray = array("SN", "ID", "ΗΜΕΡΟΜ.", "ΚΑΤΗΓΟΡΙΑ", "CALL SIGN", "ΑΡ. Α/Φ" , "ΤΥΠΟΣ Α/Φ" , "ΜΟΙΡΑ", "ΠΕΡΙΟΧΗ", "FREQ", "RADIO", "AJ", "NET", "CRYPTO", "Reason" );
                    $head = count($headArray);   
                    
                    $sql = "SELECT intercept.* FROM intercept WHERE intercept.asma='{$userAsma}' ORDER BY mdate DESC";
                    $db = new DbMgmt;
                    $res = $db->runQuery($sql);
                    $serial = 1;
                    ...
                    while ($row = mysqli_fetch_array($res)) {
                        ...
                        echo "<td class=\"asma\">" . $row['mdate'] . "</td>";
        ...
        <script type="text/javascript" src="../js/form_view_intercept_by_asma.js"></script>  
