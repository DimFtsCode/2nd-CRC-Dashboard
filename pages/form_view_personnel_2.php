        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Προβολή Προσωπικού</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                        <div class="row">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="dataTables_wrapper">
                                            ...
                                            $class = "table";
                                            $headArray = array("pri", "ΑΣΜΑ", "Βαθμός", "Ειδ.", "Επιθετο", "Ονομα", "Διεύθυνση");
                                            ...
                                            $sql = "SELECT personnel.*, divisions.description AS My_DIV, ranks.* FROM personnel, divisions, ranks WHERE personnel.division = divisions.id AND ranks.rank=personnel.rank  ORDER BY ranks.priority ASC, personnel.asma ASC";
                                            $db = new DbMgmt;                                            
                                            $res = $db->runQuery($sql);
