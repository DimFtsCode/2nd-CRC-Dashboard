           ...
           <div class="panel-heading text-center">
            ...
            <div class="panel-body">
                <div cla    ss="dataTables_wrapper">
                    ...
                    $sql = "SELECT personnel.*, divisions.*, branches.branch as MyBranch, ranks.* FROM personnel, divisions, branches, ranks WHERE personnel.division = divisions.id  AND personnel.branch=branches.id AND ranks.rank=personnel.rank  AND personnel.unit ='{$myUnit}' AND personnel.division = '{$myDivision}' ORDER BY ranks.priority ASC, personnel.asma ASC";
                    $db = new DbMgmt;
                    $res = $db->runQuery($sql);
                    $serial = 1;
