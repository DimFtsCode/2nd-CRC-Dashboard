...
<html lang="en">   
    ...
    <head>
        ...
        <title> Form View Supply by Budget </title> 
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" >
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="./form_view_supply_kae.php"> <strong style="background-color: red; color: yellow; "> Προβολή ανά ΚΑΕ </strong> </a>
           ...
           <div class="panel-heading text-center">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                                <label class="col-sm-2 control-label"> ΕΠΙΛΕΞΤΕ Budget : </label>
                                <div class="col-sm-2">
                                    <select class="form-control" id="fund" name="fund" required="fund">
            ...
            <div class="panel-body">
                <div class="dataTables_wrapper">
                    ...
                    $headArray = array("SN", "ID", "Αρ.ΕΝ", "ΗΜΕΡ. ΕΝΤ.", "ΠΕΡΙΓΡΑΦΗ", "ΔΝΣΗ",  "ΧΕΙΡΙΣΤΗΣ", "ΕΚΤ. ΚΟΣΤΟΣ", "ΠΕΡΙΓ. ΚΑΕ", "ΚΑΕ/ΑΛΕ", "ΕΙΔΟΣ ΕΝΤ.", "ΥΠΗΡ.ΣΗΜ.", "Link ΥΣ", "ΧΡΗΜΑΤ.", "ΠΑΡΑΛΗΦΘΗ", "ΠΑΡΑΓΓΕΛ.", "ΠΡΟΜΗΘΕΥΤΗΣ", "ΤΙΜΟΛΟΓΙΟ", "ΤΕΛ. ΚΟΣΤ", "STATUS", "ΠΑΡΑΤΗΡ.", "DETAIL" );
                    ...
                    $sql = "SELECT * FROM supply WHERE year = '{$DefYear}' AND own_budget = '{$myFund}' ORDER BY serial DESC ";                    
       ...
       <!-- Modal Find User Information !! -->
        ...
        <script type="text/javascript" src="../js/form_view_supply_budget.js"></script>
