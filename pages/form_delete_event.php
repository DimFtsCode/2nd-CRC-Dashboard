...
$myAsma = $user->asma;
$myIndex = $myAsma . "EVENT";
$myEvent = $_SESSION[$myIndex];
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; "> Delete Personnel Event</strong> </a>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Διαγραφή Μεταβολών Προσωπικού </h1>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">       
                                 ...
                                 <input type="text" id="myEvent" name="myEvent" class="form-control" style="display:none" value="<?php echo $myEvent?>"  >                                  
                            </div>
                        </div>   
                    ...
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_delete_event" class="form-horizontal" action="../php_functions/event_delete.php" method="POST">
                            <div id="errorDiv"> 
                                <?php
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" id="evid" name="evid" class="form-control" placeholder="Event ID" readonly>                                    
                                </div>
                            </div>    
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" id="descript" name="descript" class="form-control"   style="width: 900px;" placeholder="descript" required readonly>                                    
                                </div>
                            </div> 
                            ...
                            <div class="form-group">
                                ...
                                <div  class="input-group date col-sm-2" >
                                    <input type="text" id="date_start" name="date_start" class="form-control date datepicker" required readonly>
                            ...
                            <div class="form-group">
                                ...
                                <div  class="input-group date col-sm-2" >
                                    <input type="text" id="date_end" name="date_end" class="form-control date datepicker" required readonly>
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                </div>
                            </div>   
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" id="doc" name="doc" class="form-control"   style="width: 900px;" placeholder="doc" required readonly>                                    
                                </div>
                            </div>    
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-4">
                                    <button id="submit" type="submit" class="btn btn-default">Delete Event</button>
                                </div>
                            </div>
