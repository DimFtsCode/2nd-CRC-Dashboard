                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="panel panel-default">
                                        <div class="panel-heading text-center">
                                            ...
                                            <strong> ------ </strong>
                                             <strong><a href="./form_view_air_asset_public.php">Next</a></strong>
                                        </div>
                                        <!--                                    <div class="panel-heading text-center">
                                        ...
                                        <div class="panel-body">
                                            <div class="dataTables_wrapper">
                                                ...
                                                while ($row_line = mysqli_fetch_array($res)) {
                                                    ...
                                                    //if ($user->role == "SYS" || $user->role == "COM" || $user->role == "OPR") {
                                        ...
                                        <div class="panel-heading text-right">
                                            <?php                                           
                                                echo "<strong class=\"stat_nato\" style=\"background-color: yellow;\"> <a href=\"./form_view_air_asset_public.php\">" . " Next "  .  " </a> </strong>";                                                                                                                               
                                            ?>
