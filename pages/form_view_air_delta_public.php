...
<html lang="en">
    ...
    <head>
        ...
        <title> Form View Fighter's Readiness Delta </title>  
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        <div id="container">
            <div id="header">
                <h1> 2o AKE / Μοίρα Επιχειρήσεων -- Προβολή Ετοιμοτήτων Α/Φ Δύναμης "ΔΕΛΤΑ" </h1>
            ...
            <div id="menu">
                <ul>                   
                    ...
                    <li><a href="./form_view_air_asset_public.php"> ΕΤΟΙΜΟΤΗΤΕΣ</a> </li>
...
<!--                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="panel panel-default">
                                        <div class="panel-heading text-center">
                                            ...
                                            <strong style="color: black; background-color: yellow;"> ΔΥΝΑΜΗ ΔΕΛΤΑ  </strong>
                                            <strong> ------ </strong>
                                             <strong><a href="./form_view_sart_public.php">Next</a></strong>
                                        </div>
                                        ...
                                        <div class="panel-heading text-center">
                                            ...
                                            //echo "<strong class=\"stat_gr\" id=\"stat_gr\" style=\"background-color: yellow;\"> <a href=\"./form_edit_air_static.php\">" . " ADDITIONAL INFO : " . $row_static['delta_remark'] . " ----- " . " </a> </strong>";
                                            //} else {
                                            echo "<strong class=\"stat_gr\" id=\"stat_gr\" style=\"background-color: yellow;\"> <a href=\"#\">" . " ADDITIONAL INFO : " . $row_static['delta_remark'] . " ----- " . " </a> </strong>";    
                                            //}
                                        ...
                                        <div class="panel-body">
                                            <div class="dataTables_wrapper">
                                                ...
                                                require_once '../php_functions/db_config/db_connect.php';
                                                $class = "table";
                                                $headArray = array("SN", "ID", "BASE", "SQ", "NUM", "TYPE", "CALLSIGN", "IFF1", "IFF3", "STATUS", "TRACK", "REMARKS", "DATE_REG", "by_USER");
                                                ...
                                                $sql = "SELECT airstatus.*, bases.* FROM airstatus,bases WHERE airstatus.scope ='{$Scope}' AND airstatus.base=bases.base_name ORDER BY airstatus.air_id ASC";
                                                $db = new DbMgmt;
                                                $res = $db->runQuery($sql);
                                                $serial = 1;
                                                echo "<table class=\"table table-striped table-bordered table-hover\" id=\"view_air_delta\">";
                        ...
                        <!-- /.row -->
                                        ...
                                        <div class="panel-heading text-right">
                                            ...
                                            echo "<strong class=\"stat_nato\" style=\"background-color: yellow;\"> <a href=\"./form_view_sart_public.php\">" . " Next "  .  " </a> </strong>"; 
                                            ?>
