        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Upload CRF File </h1>
                        </div>
                    ...
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_upload_file" class="form-horizontal" action="../php_functions/upload_file.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">                       
                                <label class="col-sm-2 control-label">ΕΤΟΣ ΕΓΓΡΑΦΟΥ : </label>                            
                                <div class="col-sm-2">
                                    <input type="crfyear" id="crfyear" name="crfyear" class="form-control" placeholder="crfyear" required="crfyear" >
                                    <span class="errorFeedback errorSpan" id="crfyearError">Year  should be only four (4) digits </span>
                                </div>                           
                            </div>  
