...
<!--                    <a class="navbar-brand" href="./form_view_personnel_all.php"> <strong style="color: darkred; ">  Προβολή Συνόλου ΠΡΣ </strong> </a>  -->
           ...
           <div class="panel-heading text-center">
            ...
            <div class="panel-heading text-center">
                        <div class="col-lg-12">                            
                             <h3 class="page-header" style="color: red;"> Προβολή Συνεργασιών / Αναχαιτίσεων συγκεκριμένης Περιόδου --- από : <?php echo $myDate; ?>  --- έως : <?php echo $myDate2; ?></h3>
                        </div>                        
            </div>   
            ...
            <div class="panel-body">
                <div class="dataTables_wrapper">
                    ...
                    $class = "table";
                    //$myDate = "2022-12-20";
                    $headArray = array("SN", "AΣΜΑ", "ΟΝΟΜΑ", "ID", "ΗΜΕΡΟΜ.", "ΚΑΤΗΓΟΡΙΑ", "CALL SIGN", "ΑΡ. Α/Φ" , "ΤΥΠΟΣ Α/Φ" , "ΜΟΙΡΑ", "ΠΕΡΙΟΧΗ", "TIME","FREQ", "RADIO", "AJ", "NET", "CRYPTO", "Reason A/J", "Reason ΚΡΙΚΟ" );
                    ...
                    //$sql = "SELECT intercept.* FROM intercept WHERE (DATE(intercept.mdate) BETWEEN '{$myDate}' AND '{$myDate2}') ORDER BY mdate DESC";
        ...
        <script type="text/javascript" src="../js/form_view_intercept_bydate2.js"></script>  
