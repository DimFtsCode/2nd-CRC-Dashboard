    ...
    <body>
        ...
        <div id="wrapper">
           ...
           <div class="panel-heading text-center">
                        <div class="col-lg-12">                            
                             <h1 class="page-header" style="color: blue;"> Προβολή Μεταβολών Προσωπικού  --- <?php echo date("j - m - Y"); ?> </h1>
                        </div>                        
            </div>     
            
            <div class="panel-heading text-center">
                        <div class="col-lg-12">                            
                             <h3 class="page-header" style="color: red;"> Προβολή Μεταβολών συγκεκριμένης Περιόδου --- από : <?php echo $myDate; ?>  --- έως : <?php echo $myDate2; ?></h3>
                        </div>                        
            </div>   
