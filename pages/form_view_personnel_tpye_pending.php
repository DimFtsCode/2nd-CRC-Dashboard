...
<html lang="en">   
    ...
    <head>
        ...
        <title> Form View Personnel ΤΠΥΕ Pending </title> 
        <!-- Bootstrap Core CSS -->
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" >
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; ">  View Personnel ΤΠΥΕ Pending </strong> </a>
            ...
            <div class="panel-heading text-center">
                        <div class="col-lg-12">
                            <h1 class="page-header" style="color: red;"> Προβολή Pending ΤΠΥΕ Προσωπικού --- <?php echo date("j - m - Y"); ?></h1>
                        </div>
                        <!-- /.col-lg-12 -->
             </div> 
            ...
            <div class="panel-body">
                <div class="dataTables_wrapper">
                    ...
                    $class = "table";
                    $headArray = array("SN", "ΑΣΜΑ", "Βαθμός", "Ειδ.", "Επιθετο", "Ονομα", "Επιστασία", "ΕΝΑΡΞΗ", "ΠΕΡΑΣ", "ΝΟΣΟΚΟΜΕΙΟ", "TPYE_id");
                    $head = count($headArray);
                    $myUnit = MyUNIT;
                    $Mydate = "2000-01-01";
                    
                    $sql = "SELECT personnel.*, divisions.description AS My_DIV, ranks.*, tpye.* FROM personnel, divisions, ranks, tpye WHERE personnel.asma=tpye.asma AND personnel.division = divisions.id AND ranks.rank=personnel.rank  AND personnel.unit ='{$myUnit}' AND tpye.date_end ='{$Mydate}'   ORDER BY ranks.priority ASC, personnel.asma ASC, tpye.date_start ASC ";                  
                    ...
                    while ($row_personnel = mysqli_fetch_array($res)) {
                        ...
                        echo "<td>" . $row_personnel['date_start'] . "</td>";
