...
<html lang="en">
    ...
    <head>
        ...
        <title> Form Edit Major Event </title>
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; "> Edit Major Event </strong> </a>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Διόρθωση Σημαντικών Συμβάντων </h1>
                        </div>
                    ...
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_add_school_asma" class="form-horizontal" action="../php_functions/major_edit.php" method="POST">
                            <div id="errorDiv"> 
                                <?php
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <textarea  id="descript" name="descript" class="form-control" rows="10" placeholder="descript" required><?php echo $myDescript; ?></textarea>                                   
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" id="link" name="link" class="form-control"   style="width: 900px;" placeholder="link" >                                    
                                </div>
                            </div>  
        ...
        <script type="text/javascript" src="../js/edit_major.js"></script>
