...
<html lang="en">   
    ...
    <head>
        ...
        <title> Form Select School</title> 
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" >
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; ">  Select School </strong> </a>
            ...
            <div class="panel-heading text-center">
                        <div class="col-lg-12">
                            <h1 class="page-header" style="color: red;"> Επιλογή Σχολείου / Σεμιναρίου --- <?php echo date("j - m - Y"); ?></h1>
                        </div>
             </div>             
            ...
            <div class="panel-body">
                <div class="dataTables_wrapper">
                    ...
                    $class = "table";
                    $headArray = array("SN", "Sch ID",  "ΤΥΠΟΣ", "ΟΝΟΜΑ", "ΕΔΡΑ", "ΠΕΡΙΓΡΑΦΗ", "User_reg", "Date_reg");
                    ...
                    while ($row = mysqli_fetch_array($res)) {
                        ...
                        echo "<td class=\"shid\" > <a href=\"./form_view_personnel_byschool.php\" >" . "<strong style=\"color: blue; font-size: 16px;\">" . $row['shid'] . "</strong>". " </a> </td>";
        ...
        <script type="text/javascript" src="../js/form_select_school.js"></script>
