    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div class="panel-heading text-center">
                        <div class="col-lg-12">
                            <h1 class="page-header" style="color: red; background-color: yellow;"> Προβολή Προγραμματισμένων Αδειών Προσωπικού Τρέχοντος 'Ετους --- <?php echo date("j - m - Y"); ?></h1>
                        </div>
                        <!-- /.col-lg-12 -->
             </div> 
            ...
            <div class="panel-body">
                <div class="dataTables_wrapper">
                    ...
                    $class = "table";
                    $headArray = array("SN", "ΑΣΜΑ", "Βαθμός", "Ειδ.", "Επιθετο", "Ονομα", "Επιστασία", "ΚΑΝΟΝΙΚΗ", "ΜΙΚΡΑΣ", "ΗΜΕΡΗΣΙΑ");                    
                    ...
                    $sql = "SELECT personnel.*, divisions.description, ranks.*, pgrleave.* FROM personnel, divisions, ranks, pgrleave WHERE personnel.division = divisions.id AND ranks.rank=personnel.rank AND pgrleave.pl_asma = personnel.asma AND personnel.unit ='{$myUnit}' ORDER BY ranks.priority ASC, personnel.asma ASC, pgrleave.start_date DESC "; 
                    $db = new DbMgmt;
                    $res = $db->runQuery($sql);
        ...
        <script type="text/javascript" src="../js/form_view_pgrleave_sum1.js"></script>
