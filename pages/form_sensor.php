        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_sensor" class="form-horizontal" action="../php_functions/sensor_insert.php" method="POST">                            
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="sensor_name" class="form-control" placeholder="sensor_name" required="sensor_name">
                                </div>
                            </div>                                                        
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label"> ΠΕΡΑΣ ΕΝΕΡΓΡΕΙΩΝ : </label>
