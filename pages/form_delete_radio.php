        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0"> 
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; "> Delete Radio </strong> </a>
                </div>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Διαγραφή Ασυρμάτου </h1>                             
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_delete_radio" class="form-horizontal" action="../php_functions/radio_delete.php" method="POST">                            
...
<!--                                <button type="button" id="btn_delete" name ="btn_delete" style="background-color: yellow" style="font-size: larger"> Delete Record </button>-->
                                <span id="delete_btn" style="background-color: red"> You must select a Radio prior to DELETE it ! </span>                                                            
                            </div>    
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" id="radio_name" name="radio_name" class="form-control" placeholder="radio_name" required="radio_name" readonly>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-4">
                                    <button type="submit" class="btn btn-default" id="submit" name="submit" style="font-size: x-large"> Delete Radio</button>
                                    <span id="delete_btn" style="background-color: red"> Are you sure ?? DELETE the RADIO ?? </span>
                                </div>
                            </div>
        ...
        <script type="text/javascript" src="../js/delete_radio.js"></script> 
