...
<html lang="en">   
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" >
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red;">  View Assigned Tasks </strong> </a>
           ...
           <div class="panel-heading text-center">
                        <div class="col-lg-12">                            
                             <h1 class="page-header" style="color: red; background-color: yellow;"> Προβολή Ανατιθέμενων Εργασιών --- <?php echo date("j - m - Y"); ?> </h1>
                        </div>                        
            </div>                    
            ...
            <div class="panel-body">
                <div class="dataTables_wrapper">
                    ...
                    $sql = "SELECT * FROM taskmain WHERE (assign1 = '{$AssignedTo}' OR assign2 ='{$AssignedTo}') AND complete='{$Finished}' ORDER BY date_start DESC ";                    
        ...
        <script type="text/javascript" src="../js/form_view_job_main.js"></script>  
