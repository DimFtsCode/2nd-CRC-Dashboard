...
<html lang="en"> 
    ...
    <head>
        ...
        <title> Form View Rescue Readiness </title>  
        <!-- Bootstrap Core CSS -->
        ...
        <link rel="stylesheet" type="text/css"  href="../styles/form_view_resc_asset.css">
    ...
    <body>
        <div id="container">
            <div id="header">
                <h1> 2o AKE / Μοίρα Επιχειρήσεων -- Προβολή Ετοιμοτήτων Α/Ν Μέσων </h1>
...
<!--                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="panel panel-default">
                                        <div class="panel-heading text-center">
                                            <strong> Προβολή Ετοιμοτήτων Α/Ν Μέσων --- <?php echo date("j - m - Y"); ?> ---- </strong>
                                            <strong> ------ </strong>
                                             <strong><a href="./form_view_sam_asset_public.php">Next</a></strong>
                                        </div>                                                                                                                         
                                        ...
                                        <div class="panel-body">
                                            <div class="dataTables_wrapper">
                                                ...
                                                $class = "table";
                                                $headArray = array("SN", "ID", "AIRPORT", "NUM", "TYPE", "CALLSIGN", "STATUS",  "PERIOD", "REMARKS", "DATE_REG", "by_USER");
                                                $head = count($headArray);
                                                //$Scope = "NATIONAL";
                                                //$Period = "DAY";
                                                //$Period2 = "24H";
                                                $sql = "SELECT rescue.*, airports.* FROM rescue,airports WHERE  rescue.airport=airports.airport_name ORDER BY airports.airport_pri ASC";
                                                $db = new DbMgmt;
                                                $res = $db->runQuery($sql);
                                                $serial = 1;
                                                echo "<table class=\"table table-striped table-bordered table-hover\" id=\"view_resc_asset\">";
                                                ...
                                                while ($row_air = mysqli_fetch_array($res)) {
                                                    ...
                                                    //    echo "<td class=\"resc_id\"> <a class=\"btn btn-outline btn-primary\" href=\"./form_edit_resc_asset.php\" >" . $row_air['resc_id'] . " </a> </td>";                                                     
                                                    //} else {                                                        
                                                        echo "<td class=\"resc_id\"> <a class=\"btn btn-outline btn-primary\" >" . $row_air['resc_id'] . "  </a> </td>";
                                                    //}                                                                                                                                          
                                                    echo "<td class=\"airport\">" . $row_air['airport'] . "</td>";
                                                    ...
                                                    echo "<td class=\"daynight\">" . $row_air['daynight'] . "</td>";
                                                    ...
                                                    //    echo "<td class=\"resc_id\"> <a class=\"btn btn-outline btn-primary\" href=\"./form_delete_resc_asset.php\" >" . $row_air['resc_id'] . " </a> </td>";                                                     
                                                    //} else {                                                        
                                                    //    echo "<td class=\"resc_id\"> <a class=\"btn btn-outline btn-primary\" >" . $row_air['air_id'] . "  </a> </td>";
                                                    //}       
                                        ...
                                        <div class="panel-heading text-right">
                                            <?php
                                                echo "<strong class=\"stat_nato\" style=\"background-color: yellow;\"> <a href=\"./form_view_sam_asset_public.php\">" . " Next "  .  " </a> </strong>"; 
                                            ?>
        ...
        <script src="../js/form_view_resc_asset.js"></script>
