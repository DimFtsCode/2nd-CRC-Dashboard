...
<html lang="en">
    ...
    <head>
        ...
        <title> Form Add CRF to User </title>
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"> <strong style="color: red; "> Add CRF Files to User </strong> </a>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"> Προσθήκη CRF Αρχείου σε Προσωπικό ( έναν Χρήστη ) </h1>
                        </div>
                    ...
                    <!-- /.row -->
                    <div class="row">
                        <form id="form_add_crf1_asma" class="form-horizontal" action="../php_functions/add_crf1_asma.php" method="POST" >                           
        ...
        <script type="text/javascript" src="../js/add_crf1_asma.js"></script>
