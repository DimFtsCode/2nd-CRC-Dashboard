                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <div class="dataTables_wrapper">
                                                ...
                                                $class = "table";
                                                $headArray = array("SN", "ID", "BASE", "WEATHER", "STATUS",  "RUNWAY", "REMARKS", "DATE_REG", "by_USER", "DEL");
                                        ...
                                        <div class="panel-heading text-right">
                                            <?php
                                            if ($user->role == "SYS" || $user->role2 == "OPS+") {
                                                echo "<strong class=\"add_sart\" style=\"background-color: yellow;\"> <a href=\"./form_add_sart.php\">" . " Add new SART " . " </a> </strong>";
                                            } else {
                                                echo "<strong class=\"add_sart\" style=\"background-color: yellow;\"> <a href=\"#\">" . " Add new SART " . " </a> </strong>";
                                            }
                                            ?>
