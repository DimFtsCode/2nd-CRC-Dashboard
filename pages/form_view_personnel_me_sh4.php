...
<html lang="en">   
    ...
    <head>
        ...
        <title> Personnel ME Shift#4</title> 
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div class="panel-heading text-center">
                        ...
                        <p class="col-lg-12">
                             <h3 class="page-header" style="color: red;"> 4o ΣΜΗΝΟΣ</h3>
                        </p>
                        <!-- /.col-lg-12 -->
             </div>     
            ...
            <div class="panel-body">
                <div cla    ss="dataTables_wrapper">
                    ...
                    //$sql = "SELECT personnel.*, divisions.*, branches.branch as MyBranch, ranks.* FROM personnel, divisions, branches, ranks WHERE personnel.division = divisions.id  AND personnel.branch=branches.id AND ranks.rank=personnel.rank  AND personnel.unit ='{$myUnit}' AND personnel.division ='{$myDivision}' AND personnel.branch ='{$myBranch1}' ORDER BY ranks.priority ASC, personnel.asma ASC";
