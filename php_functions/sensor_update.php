...
if (isset($sensor_id_update)) {
    if (isset($status_update)) {
        ...
        $sql_update_sensor = "UPDATE sensor SET status='$status_update', reason='$reason_update', action='$action_update', tbc='$date_update', user_reg='$user_reg', date_reg= NOW() WHERE sensor_id='$sensor_id_update'";
