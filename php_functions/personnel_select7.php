...
$findPerson = "SELECT personnel.*, divisions.description AS My_DIV, branches.branch as MyBranch FROM personnel, divisions, branches WHERE personnel.division = divisions.id  AND personnel.branch=branches.id AND personnel.asma ='{$myAsma}' ";
...
$person = array(
    ...
    "unit" =>$findRow['unit'],
    "directorate" =>$findRow['My_DIV'],
    "branch" =>$findRow['MyBranch'],
