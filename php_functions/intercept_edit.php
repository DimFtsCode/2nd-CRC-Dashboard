...
$remark = $db->quote($_POST['remark']);   
    ...
    $user_reg = $user->asma;
     ...
     $query = "UPDATE `intercept` SET `cotype`='$cotype', `mdate`='$mdate', `stime`='$stime', `ltime`='$ltime', `fcs1`='$fcs1', `numf1`='$numf1', `typef1`='$typef1', `sq1`='$sq1', `fcs2`='$fcs2', `numf2`='$numf2', `typef2`='$typef2', `sq2`='$sq2', `fcs3`='$fcs3', `numf3`='$numf3', `typef3`='$typef3', `sq3`='$sq3', `fcs4`='$fcs4', `numf4`='$numf4', `typef4`='$typef4', `sq4`='$sq4'," 
             ."`extcard`='$extcard', `area`='$area', `alt`='$alt', `numint`='$numint', `intype`='$intype', `numint2`='$numint2', `intype2`='$intype2', `freq`='$freq', `radio`='$radio', `post`='$post', `aj`='$aj', `ajnet`='$ajnet', `crypto`='$crypto', `mids`='$mids', `comq`='$comq', `eng`='$eng', `iff`='$iff', `reason`='$reason', `reason2`='$reason2', `remark`='$remark', `user_reg`='$user_reg', `date_reg`=NOW() WHERE `int_id`='$int_id' ";
