$(document).ready(function () {
    ...
    $("#form_edit_secmoto_asma").submit(function (e) {
        removeFeedback();
...
window.onload = function () {
        ...
        //alert($event);  
        $.ajax({
            url: '../php_functions/secmoto_select.php',
            type: 'post',
            data: data1,
            dataType: 'JSON',
            success: function (response) {
                ...
                $("#expmoto").val(response.expmoto);
                $("#typec").val(response.typec);
